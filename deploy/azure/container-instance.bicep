...
@description('Azure region for the NamVu Design container group and storage account.')
...
@description('NamVu Design container image.')
param image string = 'ghcr.io/nexu-io/od:latest'

@secure()
@description('Required NamVu Design API token. Generate with: openssl rand -hex 32')
...
@description('Azure Files share quota in GiB for persistent NamVu Design data.')
@minValue(1)
@maxValue(5120)

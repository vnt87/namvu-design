...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows NamVu Design's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# NamVu Design integration — MUST follow

You are running inside NamVu Design, a design tool. The user message contains

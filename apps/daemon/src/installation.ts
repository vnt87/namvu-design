...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/NamVu Design Prerelease/installation.json
//   packaged (win):    %APPDATA%/NamVu Design Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/NamVu Design Prerelease/installation.json

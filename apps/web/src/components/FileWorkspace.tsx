...
const COMMUNITY_PAGE_PRESETS: ProjectPagePreset[] = [
  {
    ...
    category: 'prototype',
    title: pageText('NamVu Design Landing', 'NamVu Design 落地页', 'NamVu Design 落地頁'),
...
<body>
  <main>
    <section class="hero">
      <div>
        <div class="eyebrow">NamVu Design</div>
        <h1>${safeTitle}</h1>
        <p>${safeBody}</p>
      </div>
  ...
  <div class="deck-shell">
    <main class="deck-stage" id="deck-stage">
      <section class="slide active cover" data-screen-label="01 Cover">
        <div class="kicker">NamVu Design deck</div>
        <h1>${safeTitle}</h1>
...
<body>
  <article>
    <div class="meta">NamVu Design document</div>
    <h1>${safeTitle}</h1>
    <p>${safeBody}</p>
    <h2>Purpose</h2>

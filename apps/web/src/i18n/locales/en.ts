...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to NamVu Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to NamVu Design Cloud & retry',
  'chat.amrError.authMessage': 'Your NamVu Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your NamVu Design Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with NamVu Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the NamVu Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The NamVu Design Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the NamVu Design Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update NamVu Design to the latest version, which ships a compatible runtime.",
  ...
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. NamVu Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. NamVu Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the NamVu Design hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to NamVu Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to NamVu Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to NamVu Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the NamVu Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to NamVu Design.',
  ...
  'settings.amrAccountStatus': 'NamVu Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose NamVu Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the NamVu Design team',
  'settings.privacyConsentKicker': 'Help us improve NamVu Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how NamVu Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time NamVu Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but NamVu Design could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect NamVu Design to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure NamVu Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in NamVu Design as context.',
  'settings.mcpRunningNote': 'Keep NamVu Design running. Restart your coding agent after setup.',
  ...
  'entry.discordAria': 'Join the NamVu Design Discord',
  'entry.discordAriaWithOnline': 'Join the NamVu Design Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.mailAria': 'Email NamVu Design',
  ...
  'entry.followLinkedinLabel': 'Follow NamVu Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow NamVu Design on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use NamVu Design Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss NamVu Design Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable NamVu Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit NamVu Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local NamVu Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. NamVu Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use NamVu Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with NamVu Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to NamVu Design',
  'pluginCard.contributeTitle': 'Contribute plugin to NamVu Design with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use NamVu Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure NamVu Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use NamVu Design everywhere',
  'useEverywhere.modalTitle': 'Use NamVu Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop NamVu Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'NamVu Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'NamVu Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires NamVu Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without NamVu Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive NamVu Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose NamVu Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'NamVu Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover NamVu Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the NamVu Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without NamVu Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). NamVu Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside NamVu Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + NamVu Design extras)',
  ...
  'entry.githubStarAria': 'Star NamVu Design on GitHub',
  ...
  'newproj.locationDefault': 'NamVu Design projects',
  ...
  'avatar.amrConsole': 'NamVu Design Cloud',
  ...
  'socialShare.openDesignSection': 'Share NamVu Design',
  'socialShare.openDesignTitle': 'NamVu Design on GitHub',
  'socialShare.openDesignText': 'NamVu Design is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with NamVu Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with NamVu Design: {title}\n{url}\nNamVu Design repo: {repo}',
  ...
  'brandEnrichment.body': "NamVu Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask NamVu Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want NamVu Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure NamVu Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying NamVu Design? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to NamVu Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow NamVu Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow NamVu Design on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to NamVu Design Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to NamVu Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with NamVu Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with NamVu Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple NamVu Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions NamVu Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'NamVu Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'NamVu Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'NamVu Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. NamVu Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit NamVu Design',
  'updater.quitFailedBody': 'The installer is open, but NamVu Design could not quit. Quit NamVu Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. NamVu Design will close and open the installer.',
  'updater.readyVersion': 'NamVu Design {version} is ready. NamVu Design will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. NamVu Design will close and open the installer.',
  'updater.reinstallReadyVersion': 'NamVu Design {version} requires a full reinstall. NamVu Design will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach NamVu Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions NamVu Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach NamVu Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'NamVu Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 6–13, paid users can use DeepSeek V4 Flash for free in NamVu Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 6–13',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'one week free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside NamVu Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with NamVu Design.',

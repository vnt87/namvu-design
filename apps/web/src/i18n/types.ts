// Locale values accepted at API boundaries remain backwards-compatible with
// persisted/project metadata. Only `LOCALES` is user-selectable and contains
// the currently supported UI languages.
...
export interface Dict {
  ...
  'settings.statisticsHint': string;
  'settings.statisticsTitle': string;
  'settings.statisticsDescription': string;
  'settings.statisticsLocalBadge': string;
  'settings.statisticsRange': string;
  'settings.statisticsAllTime': string;
  'settings.statisticsClearFilters': string;
  'settings.statisticsLoadError': string;
  'settings.statisticsRetry': string;
  'settings.statisticsResetConfirm': string;
  'settings.statisticsResetError': string;
  'settings.statisticsRuns': string;
  'settings.statisticsTokens': string;
  'settings.statisticsTime': string;
  'settings.statisticsGenerationTime': string;
  'settings.statisticsArtifacts': string;
  'settings.statisticsFeatures': string;
  'settings.statisticsActivity': string;
  'settings.statisticsResults': string;
  'settings.statisticsModels': string;
  'settings.statisticsTools': string;
  'settings.statisticsRecent': string;
  'settings.statisticsEmpty': string;
  'settings.statisticsEmptyHint': string;
  'settings.statisticsReset': string;
  'settings.statisticsResetHint': string;
  'settings.statisticsProject': string;
  'settings.statisticsWorkspace': string;
  'settings.statisticsModel': string;
  'settings.statisticsProvider': string;
  'settings.statisticsFeature': string;
  'settings.statisticsSuccess': string;
  'settings.statisticsInput': string;
  'settings.statisticsOutput': string;
  'settings.statisticsCategory': string;
  'settings.statisticsResult': string;
  'settings.statisticsLoadMore': string;
}

# Pricing — NamVu Design

NamVu Design is **free and open-source**. The desktop app (macOS, Windows, Linux)
...
Nothing is proxied through NamVu Design.
...
not required to use NamVu Design.
...
- Model access: **BYOK** — bring your own provider key; API usage bills to your
  own account, never proxied through NamVu Design
...
- The open-source desktop app is always free; the paid tiers are an optional
  ...
  requirement to use NamVu Design.

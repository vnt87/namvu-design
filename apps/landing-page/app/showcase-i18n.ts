 ...
 *
 * The showcase is a curated gallery of REAL NamVu Design output — shipped
...
const en: ShowcaseCopy = {
  meta: {
    title: 'Showcase — real work generated with NamVu Design',
    description:
      'A curated gallery of real output — launch sites, prototypes, decks, and motion pieces generated with NamVu Design. Judge the quality yourself.',
  },
  hero: {
    label: 'Showcase',
    title: 'Real work, generated with NamVu Design.',
  ...
  works: {
    ...
    'opendesign-y2k': {
      title: 'NamVu Design — Y2K brand page',
    ...
    'launch-0-10-0': {
      title: 'NamVu Design 0.10.0 launch film',
      blurb: '“From prompts to design loops.” The 0.10.0 release film, authored end-to-end in Hyperframes.',
    },
    'launch-0-9-0': {
      title: 'NamVu Design 0.9.0 launch film',
      blurb: '“Bring any model. Run any agent.” The 0.9.0 release film, authored in Hyperframes.',
    },
    'cloud-fable5': {
      title: 'NamVu Design Cloud × Claude Fable 5',
      blurb: 'Partnership announcement film for Claude Fable 5 on NamVu Design Cloud, generated with Seedance 2.0.',
    },
    'event-shanghai': {
  ...
  figma: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Generated by the coding agents and models you already use; NamVu Design orchestrates them into design work.',
      },
      {
    ...
    compareCta: 'See how NamVu Design compares',
  },
};

const zhCN: DeepPartial<ShowcaseCopy> = {
  meta: {
    title: '作品展示 — 用 NamVu Design 生成的真实作品',
    description:
      '精选真实产出画廊 — 用 NamVu Design 生成的发布站点、原型、演示 deck 与动效视频。质量如何，自己判断。',
  },
  hero: {
    label: '作品展示',
    title: '真实作品，由 NamVu Design 生成。',

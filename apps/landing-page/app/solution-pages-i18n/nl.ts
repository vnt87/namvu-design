...
export const NL: SolutionLocaleCopy = {
  prototype: {
    title: 'Bouw interactieve prototypes met NamVu Design + Claude Code',
    description:
      'Verander een prompt in een aanklikbaar prototype met meerdere schermen zonder je terminal te verlaten. NamVu Design geeft je coding agent de ontwerpvaardigheden, sjablonen en het designsysteem om echte prototypes te maken die je in een browser kunt openen.',
    ...
    tldrBody:
      'NamVu Design is de ontwerplaag voor de coding agent die je al gebruikt. Voor prototyping betekent dat: van een idee van één alinea naar een navigeerbaar, gestileerd prototype in één sessie — geen ontwerptool, geen exportstap, geen overdrachtskloof.',
    stepsTitle: 'Hoe prototyping werkt met NamVu Design',
    steps: [
      {
        title: 'Beschrijf de flow',
        body: 'Vertel je agent in gewone taal wat je bouwt — “een onboardingflow met een welkomstscherm, een abonnementskiezer en een bevestiging.” NamVu Design laadt de prototypevaardigheid, zodat de agent weet dat hij schermen moet maken, niet één pagina.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'De agent past een designsysteem en prototypesjablonen uit NamVu Design toe, zodat elk scherm typografie, witruimte en componenten deelt in plaats van op een ruwe schets te lijken. Je krijgt een samenhangende set schermen, geen losse mockups.',
        imageAlt:
    ...
    tableTitle: 'Prototyping met NamVu Design versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Prototypes die mensen bouwden met NamVu Design',
    galleryLead:
    ...
    faq: [
      {
        q: 'Heb ik een ontwerptool als Figma nodig om te prototypen met NamVu Design?',
        a: 'Nee. NamVu Design draait binnen je coding agent en rendert prototypes naar HTML. Je beschrijft de flow in taal; de agent maakt de schermen. Er is geen aparte canvastool om te leren of voor te betalen.',
      },
      {
      ...
      },
      {
        ...
        a: 'NamVu Design werkt met Claude Code, Codex, Cursor Agent, Gemini CLI en een tiental andere eigen adapters. Je gebruikt je eigen providersleutels; er wordt niets voor je gehost.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander je volgende “wat als” in iets dat je kunt aanklikken — in de agent die je al gebruikt.',
  },
  dashboard: {
    title: 'Genereer datadashboards met NamVu Design + Claude Code',
    description:
    ...
    lead: 'Vertel je agent wat hij moet tonen en hoe het moet aanvoelen. NamVu Design levert de grafiekpatronen, het indelingssysteem en de visuele taal, zodat je een samenhangend, presentabel dashboard krijgt — geen muur van standaard gestileerde widgets.',
    heroImageAlt:
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design verandert een specificatie van je metrics in gewone taal in een gestileerd dashboard dat je agent naar HTML rendert — geversioneerd in je repo, overal te hosten, zonder BI-abonnement per seat.',
    stepsTitle: 'Hoe dashboards werken met NamVu Design',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'NamVu Design levert grafiek- en indelingssjablonen, zodat trends lijngrafieken worden, uitsplitsingen staven en verhoudingen het juiste beeld — consistente typografie en witruimte overal in plaats van niet-passende standaarden.',
    ...
    tableTitle: 'Dashboards met NamVu Design versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Dashboards die mensen bouwden met NamVu Design',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. NamVu Design rendert dashboards naar HTML binnen je coding agent. Je beschrijft de metrics en wijst hem naar je data; er is geen apart BI-platform om te licentiëren of te leren.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander je metrics in een dashboard dat je overal kunt hosten — in de agent die je al gebruikt.',
  },
  slides: {
    title: 'Genereer presentatiedecks met NamVu Design + Claude Code',
    description:
      'Verander een outline in een ontworpen, on-brand slidedeck zonder een presentatie-app te openen. NamVu Design geeft je coding agent decksjablonen en een visueel systeem, en rendert slides naar HTML die je kunt presenteren, exporteren of delen.',
    breadcrumb: 'Slides',
    label: 'Toepassing · Slides',
    heading: 'Decks die ontworpen ogen, geschreven door een prompt',
    lead: 'Geef je agent een outline en een toon. NamVu Design past een decksjabloon en visueel systeem toe, zodat elke slide opgemaakt, gezet en on-brand is — geen opsomming op een lege achtergrond.',
    heroImageAlt:
      'Redactionele illustratie van een outline links die verandert in een reeks ontworpen presentatieslides rechts',
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design verandert een outline in een ontworpen HTML-deck dat je agent in één sessie rendert — presenteer het in de browser, exporteer naar PDF of PPTX, en houd de bron in je repo.',
    stepsTitle: 'Hoe decks werken met NamVu Design',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'NamVu Design levert decksjablonen — redactioneel, Zwitsers-internationaal, donker technisch en meer. De agent past er één toe, zodat typografie, raster en accenten over elke slide consistent blijven.',
    ...
    tableTitle: 'Decks met NamVu Design versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Decks die mensen bouwden met NamVu Design',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. NamVu Design rendert decks naar HTML binnen je coding agent en kan exporteren naar PDF of PPTX. Je presenteert vanuit de browser of draagt een bestand over — er is geen presentatie-app nodig om het te bouwen.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander je outline in een ontworpen deck — in de agent die je al gebruikt.',
  },
  image: {
    title: 'Genereer on-brand graphics met NamVu Design + Claude Code',
    description:
    ...
    lead: 'Beschrijf de kaart of omslag die je nodig hebt. NamVu Design stelt hem samen met echte typografie, raster en jouw merkkleuren — en rendert vervolgens naar HTML die je als afbeelding kunt exporteren, in plaats van te worstelen met een ontwerp-app of een generiek sjabloon.',
    heroImageAlt:
      'Redactionele illustratie van een prompt die verandert in een set opgemaakte socialkaarten en artikelomslagen',
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design verandert een prompt in een gezette, on-brand graphic die je agent naar HTML rendert en naar PNG exporteert — herhaalbaar, geversioneerd en vrij van ontwerptools per seat.',
    stepsTitle: 'Hoe graphics werken met NamVu Design',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'NamVu Design haalt je kleuren, typografie en witruimte uit een herbruikbaar designsysteem, zodat elke kaart bij de rest van je merk past in plaats van eenmalig te ogen.',
    ...
    tableTitle: 'Graphics met NamVu Design versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Graphics die mensen bouwden met NamVu Design',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. NamVu Design stelt graphics samen met echte opmaak en typografie — jouw kop, jouw merk, exacte afmetingen — en rendert naar HTML die je als PNG exporteert. Het is ontwerpcompositie, geen pixelgeneratie.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander een prompt in een on-brand graphic — in de agent die je al gebruikt.',
  },
  video: {
    title: 'Genereer motion graphics en korte video met NamVu Design + Claude Code',
    description:
    ...
    lead: 'Beschrijf het moment dat je wilt — een titelonthulling, een data-animatie, een logo-outro. NamVu Design stelt geanimeerde frames samen met jouw merksysteem en rendert ze naar video, zonder dat er een motion-graphics-suite nodig is.',
    heroImageAlt:
      'Redactionele illustratie van een script dat verandert in een reeks geanimeerde videoframes',
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design verandert een script in geanimeerde, on-brand frames die je agent naar korte video rendert — samengesteld uit HTML, geversioneerd in je repo, zonder tijdlijneditor om te leren.',
    stepsTitle: 'Hoe motion werkt met NamVu Design',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'NamVu Design levert framesjablonen — cinematische light leaks, glitch-titels, logo-outro’s — en past jouw kleuren en typografie toe, zodat de beweging doelbewust en on-brand oogt.',
    ...
    tableTitle: 'Motion met NamVu Design versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Motion die mensen bouwden met NamVu Design',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. NamVu Design stelt geanimeerde frames samen in HTML en rendert ze naar video binnen je coding agent. Er is geen tijdlijneditor om te leren of te licentiëren.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander een script in motion — in de agent die je al gebruikt.',
  },
  designSystem: {
    title: 'Bouw en pas een designsysteem toe met NamVu Design + Claude Code',
    description:
    ...
    lead: 'Definieer je merk één keer en NamVu Design draagt het mee naar elke uitvoer — prototypes, decks, dashboards, graphics. Het systeem leeft in je repo als een DESIGN.md die de agent leest, zodat consistentie automatisch is, niet handmatig.',
    heroImageAlt:
      'Redactionele illustratie van één designsysteem dat uitstraalt naar vele on-brand artefacten',
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design vangt je merk als een draagbaar designsysteem dat je agent toepast op elk artefact — één keer gedefinieerd in je repo, overal afgedwongen, zonder een centrale ontwerptool die de poort bewaakt.',
    stepsTitle: 'Hoe designsystemen werken met NamVu Design',
    steps: [
      {
        title: 'Vang het systeem',
        body: 'Beschrijf je merk — kleuren, typografie, witruimte, stem — of wijs de agent naar een bestaande site om het te extraheren. NamVu Design schrijft het in een DESIGN.md die in je project leeft.',
        imageAlt: 'Illustratie van een merk dat wordt gevangen in één designsysteembestand',
      },
      {
        title: 'Begin vanuit een bewezen basis',
        body: 'NamVu Design levert 140+ referentiedesignsystemen — van Apple en Linear tot redactioneel en brutalistisch. Fork er een dicht bij je merk in plaats van te beginnen met een lege pagina.',
    ...
    tableTitle: 'Designsystemen met NamVu Design versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Designsystemen in NamVu Design',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Een DESIGN.md-bestand in je repo dat kleuren, typografie, witruimte, componenten en stem vangt. Elke NamVu Design-vaardigheid leest het, zodat je merk automatisch wordt toegepast op alles wat de agent produceert.',
      },
      {
        q: 'Moet ik vanaf nul beginnen?',
        a: 'Nee. NamVu Design levert 140+ referentiedesignsystemen die je kunt forken — van Apple en Linear tot redactioneel en brutalistisch — en daarna aan je merk aanpassen.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en geef je agent één merk om overal toe te passen — in de agent die je al gebruikt.',
  },
  roleSoloBuilder: {
    title: 'NamVu Design voor solobouwers & indie hackers',
    description:
      'Lever als een team van één. NamVu Design verandert je coding agent in de ontwerphelft van je startup — prototypes, landingspaginas, dashboards en merkvisuals, allemaal vanuit een prompt, allemaal op merk, allemaal in je repo.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design is de ontwerpafdeling die een solo-oprichter nooit had: van prompt naar artefact op elk oppervlak dat je product nodig heeft, op één merk, zonder overdracht en zonder extra tools.',
    stepsTitle: 'Hoe een solobouwer NamVu Design gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Solo bouwen met NamVu Design vs het op de moeilijke manier doen',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Solo gebouwd met NamVu Design',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en laat één agent je ontwerpteam zijn — in de agent die je al gebruikt.',
  },
  roleDesigner: {
    title: 'NamVu Design voor ontwerpers',
    description:
      'Besteed je tijd aan smaak, niet aan sleurwerk. NamVu Design laat je agent het repetitieve productiewerk afhandelen — varianten, statussen, complete ontwerpsystemen — terwijl jij de look stuurt en het laatste woord houdt.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design is de productieassistent die nooit moe wordt: jij definieert het ontwerpsysteem en bepaalt de smaak; de agent genereert de rest, op systeem, in je repo.',
    stepsTitle: 'Hoe een ontwerper NamVu Design gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Ontwerpen met NamVu Design vs de handmatige manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Gestuurd met NamVu Design',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en laat de agent de productie afhandelen terwijl jij de smaak bepaalt — in de agent die je al gebruikt.',
  },
  roleEngineering: {
    title: 'NamVu Design voor engineers',
    description:
      'Sla de ontwerpoverdracht over. NamVu Design verandert een DESIGN.md in echte front-end die je coding agent rechtstreeks schrijft — op-systeem UI, prototypes en dashboards, in de repo, zonder Figma-heen-en-weer.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design dicht de kloof tussen ontwerper en engineer door het ontwerpsysteem machineleesbaar te maken: dezelfde agent die je code schrijft, past het systeem toe en rendert echte UI.',
    stepsTitle: 'Hoe een engineer NamVu Design gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Front-end met NamVu Design vs de overdrachtsmanier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Gebouwd door engineers met NamVu Design',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander een DESIGN.md in front-end — in de agent die je al gebruikt.',
  },
  roleProductManagers: {
    title: 'NamVu Design voor productmanagers',
    description:
      'Wacht niet meer op ontwerpcapaciteit om een idee over te brengen. NamVu Design laat een PM een prompt veranderen in een klikbaar prototype of wireframe — om stakeholders op één lijn te brengen en het team te briefen, zonder ontwerpticket.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design geeft een PM een ontwerpvrije manier om ideeën tastbaar te maken: van prompt naar prototype voor afstemming en briefings, zonder het ontwerpbudget van het team uit te geven.',
    stepsTitle: 'Hoe een PM NamVu Design gebruikt',
    steps: [
      {
        title: 'Beschrijf de flow',
    ...
    tableTitle: 'PM-werk met NamVu Design vs wachten op ontwerp',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    ...
    galleryTitle: 'Geprototypeerd door PMs met NamVu Design',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander je volgende spec in iets waar mensen op kunnen klikken — in de agent die je al gebruikt.',
  },
  roleMarketing: {
    title: 'NamVu Design voor marketingteams',
    description:
      'Lever campagnes op contentsnelheid. NamVu Design laat je agent landingspaginas, socialkaarten en campagnevisuals produceren vanuit een prompt — op merk, op aanvraag, zonder ontwerp in de wachtrij te zetten.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'NamVu Design is de altijd-beschikbare ontwerpresource voor marketing: van prompt naar asset voor landingspaginas en social, op merk, zodat campagnes worden geleverd op de snelheid waarmee je tekst schrijft.',
    stepsTitle: 'Hoe een marketingteam NamVu Design gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Marketing met NamVu Design vs de gebruikelijke ren',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met NamVu Design',
    tableColWithout: 'Zonder het vandaag',
    tableRows: [
    ...
    galleryTitle: 'Geleverd door marketing met NamVu Design',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer NamVu Design en verander briefs in assets op merk — in de agent die je al gebruikt.',
  },
};

...
export const JA: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'AI ワイヤーフレームジェネレーター — NamVu Design でプロンプトからワイヤーフレームへ',
    description:
      'プロンプトを、編集可能なマルチスクリーンのワイヤーフレームに変え、そのまま出荷できるコードまで運ぶ、無料でオープンソースの AI ワイヤーフレームジェネレーター。NamVu Design はあなたがすでに使っているコーディングエージェントの中で動くので、ワイヤーフレームと実際のプロダクトが一つの情報源を共有します。',
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていの AI ワイヤーフレームジェネレーターは、後で作り直す絵を渡してくるだけです。NamVu Design はワイヤーフレームをコーディングエージェントの中で生成し、プロンプトから出荷できるコードまで運びます — エクスポート工程も、引き継ぎの断絶も、シート単位の課金もありません。',
    stepsTitle: 'AI ワイヤーフレームジェネレーターの仕組み',
    steps: [
      {
        title: '画面を説明する',
        body: 'ワイヤーフレームにしたいものを普通の言葉でエージェントに伝えます。「サイドバー、統計の行、最近のアクティビティのテーブルがあるダッシュボード」のように。NamVu Design がワイヤーフレームスキルを読み込むので、エージェントは単一の静止画ではなく、構造と階層をレイアウトします。',
    ...
    tableTitle: 'NamVu Design vs 一般的な AI ワイヤーフレームジェネレーター',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られたワイヤーフレーム',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — ワイヤーフレームジェネレーター自体にシート単位やクレジット単位の課金はありません。',
      },
      {
      ...
      {
        q: 'どのエージェントで動きますか？',
        a: 'NamVu Design は Claude Code、Codex、Cursor Agent、Gemini CLI、その他十数種のファーストパーティアダプターで動作します。プロバイダーの鍵は自分で持ち込み、何もホストされません。',
      },
    ],
    ctaTitle: '今夜、最初のワイヤーフレームを生成する',
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次の画面のアイデアを、すでに使っているエージェントの中で、編集可能なワイヤーフレームに — そして出荷できるコードに — 変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'AI UI ジェネレーター' },
      { href: '/solutions/design-to-code/', label: 'NamVu Design でデザインからコードへ' },
      { href: '/blog/design-to-code-tools/', label: '最高のデザイン・トゥ・コードツール' },
      { href: '/solutions/prototype/', label: 'NamVu Design でのプロトタイピング' },
    ],
  },
  aiUiGenerator: {
    title: 'AI UI ジェネレーター — NamVu Design でプロンプトから本番 UI へ',
    description:
      'プロンプトを、本物のコンポーネントベースのインターフェースに変え、そのまま出荷できるコードまで運ぶ、無料でオープンソースの AI UI ジェネレーター。NamVu Design はあなたがすでに使っているコーディングエージェントの中で動くので、生成された UI と本番コードが同じ成果物です。',
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていの AI UI ジェネレーターは、モックアップか使い捨ての React スニペットを渡してくるだけです。NamVu Design は UI をコーディングエージェントの中で生成し、プロンプトから出荷できるコードまで運びます — 本物のコンポーネント、あなたのデザインシステム、エクスポート工程なし、シート単位の課金なし。',
    stepsTitle: 'AI UI ジェネレーターの仕組み',
    steps: [
      {
        title: 'インターフェースを説明する',
        body: '作りたいものを普通の言葉でエージェントに伝えます。「サイドバー、タブ分けされたセクション、保存バーがある設定ページ」のように。NamVu Design が UI スキルを読み込むので、エージェントは一度きりの画面ではなく、本物のコンポーネントとデザインシステムに手を伸ばします。',
    ...
    tableTitle: 'NamVu Design vs 一般的な AI UI ジェネレーター',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られた UI',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — UI ジェネレーター自体にシート単位やクレジット単位の課金はありません。',
      },
      {
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次のインターフェースのアイデアを、すでに使っているエージェントの中で、本物のコンポーネントベースの UI に — そして出荷できるコードに — 変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'AI ワイヤーフレームジェネレーター' },
      { href: '/solutions/design-to-code/', label: 'NamVu Design でデザインからコードへ' },
      { href: '/blog/best-ai-design-tools/', label: '最高の AI デザインツール' },
      { href: '/solutions/designer/', label: 'デザイナーのための NamVu Design' },
    ],
  },
  designToCode: {
    title: 'デザイン・トゥ・コード — NamVu Design でデザインを出荷できるコードに変える',
    description:
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていのデザイン・トゥ・コードツールは、その後あなたが世話をする一度きりのスナップショットをエクスポートします。NamVu Design はデザインとコードを、エージェントの中で一つの生きた成果物として保ちます — 話しながら反復し、自分のものになるコードを出荷し、シート単位の課金はありません。',
    stepsTitle: 'デザイン・トゥ・コードの仕組み',
    steps: [
      {
        title: 'プロンプトかデザインから始める',
        body: '画面を普通の言葉で説明するか、デザインの方向性をエージェントに指し示します。NamVu Design が適切なスキルを読み込むので、エージェントは脆い一度きりの変換ではなく、構造とコンポーネントを構築します。',
    ...
    tableTitle: 'NamVu Design vs 一般的なデザイン・トゥ・コードツール',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design でデザインから出荷',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — デザイン・トゥ・コードのワークフロー自体にシート単位やクレジット単位の課金はありません。',
      },
      {
        q: 'どんな種類のコードを生み出しますか？',
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次の画面を — プロンプト、ワイヤーフレーム、デザインのいずれでも — すでに使っているエージェントの中で、きれいで出荷できるコードに変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'AI ワイヤーフレームジェネレーター' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI ジェネレーター' },
      { href: '/blog/design-to-code-tools/', label: '最高のデザイン・トゥ・コードツール' },
      { href: '/solutions/engineering/', label: 'エンジニアリングのための NamVu Design' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'AI ランディングページジェネレーター — プロンプトから出荷できるランディングページへ',
    description:
      'プロンプトを、本物でレスポンシブなランディングページに変え、そのまま出荷できるコードまで運ぶ、無料でオープンソースの AI ランディングページジェネレーター。NamVu Design はあなたがすでに使っているコーディングエージェントの中で動くので、生成されたページとデプロイされたページが、あなたの所有する同じ成果物です。',
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていの AI ランディングページビルダーは、あなたのページを彼らのエディター内に閉じ込め、シート単位で課金します。NamVu Design はランディングページをコーディングエージェントの中で生成し、プロンプトから出荷できるコードまで運びます — 本物のセクション、あなたのブランド、エクスポート工程なし、シート単位の課金なし。',
    stepsTitle: 'AI ランディングページジェネレーターの仕組み',
    steps: [
      {
        title: 'ページを説明する',
        body: '作りたいものを普通の言葉でエージェントに伝えます。「メモアプリのローンチページ：ヒーロー、3 つの機能、料金、ウェイトリストのフォーム」のように。NamVu Design がランディングページスキルを読み込むので、エージェントは明確な階層を備えた本物のセクションをレイアウトします。',
    ...
    tableTitle: 'NamVu Design vs 一般的な AI ランディングページビルダー',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られたランディングページ',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — ランディングページジェネレーター自体にシート単位やページ単位の課金はありません。',
      },
      {
        q: 'ページはどこにでもホストできますか？',
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次のローンチのアイデアを、すでに使っているエージェントの中で、本物でレスポンシブなランディングページに — そして出荷できるコードに — 変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'AI UI ジェネレーター' },
      { href: '/solutions/design-to-code/', label: 'NamVu Design でデザインからコードへ' },
      { href: '/solutions/marketing/', label: 'マーケティングのための NamVu Design' },
      { href: '/blog/best-ai-design-tools/', label: '最高の AI デザインツール' },
    ],
  },
  figmaToCode: {
    title: 'Figma・トゥ・コード — NamVu Design で Figma のデザインを出荷できるコードに変える',
    description:
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていの Figma・トゥ・コードのプラグインは、その後あなたが書き直す絶対配置マークアップの一度きりのスナップショットをエクスポートします。NamVu Design はデザインとコードを、エージェントの中で一つの生きた成果物として保ちます — Figma MCP を通じてフレームを引き込み、話しながら反復し、自分のものになるコードを出荷します。',
    stepsTitle: 'Figma・トゥ・コードの仕組み',
    steps: [
      {
        title: 'Figma をエージェントに接続する',
        body: 'Figma MCP を設定すれば、あなたのコーディングエージェント — Claude Code、Codex、Cursor Agent — が Figma ファイルや選択したフレームを直接読めます。NamVu Design が適切なスキルを読み込むので、エージェントは脆いピクセルコピーではなく、デザインの意図を構造に変えます。',
    ...
    tableTitle: 'NamVu Design vs 一般的な Figma・トゥ・コードツール',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で Figma から出荷',
    galleryLead:
    ...
    faq: [
      {
        q: 'NamVu Design はどうやって Figma をコードに変えますか？',
      ...
      {
        q: '無料ですか？',
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — Figma・トゥ・コードのワークフロー自体にシート単位やエクスポート単位の課金はありません。',
      },
      {
        q: 'どのエージェントで動きますか？',
        a: 'NamVu Design は Claude Code、Codex、Cursor Agent、Gemini CLI、その他十数種のファーストパーティアダプターで動作します。プロバイダーの鍵と自分の Figma MCP のセットアップは自分で持ち込み、何もホストされません。',
      },
    ],
    ctaTitle: '今夜、次の Figma フレームをコードに変える',
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールし、Figma MCP を接続して、次の Figma のデザインを、すでに使っているエージェントの中で、きれいで出荷できるコードに変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/design-to-code/', label: 'NamVu Design でデザインからコードへ' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI ジェネレーター' },
      { href: '/agents/claude-code-design/', label: 'Claude Code のための NamVu Design' },
      { href: '/solutions/engineering/', label: 'エンジニアリングのための NamVu Design' },
    ],
  },
  screenshotToCode: {
    title: 'スクリーンショット・トゥ・コード — NamVu Design でスクリーンショットをコードに変える',
    description:
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていのスクリーンショット・トゥ・コードツールは、その後あなたが書き直す一度きりの絶対配置マークアップを吐き出します。NamVu Design はスクリーンショットを、コーディングエージェントの中できれいでコンポーネントベースのコードとして再構築します — 本物の構造、あなたのデザインシステム、エクスポート工程なし、シート単位の課金なし。',
    stepsTitle: 'スクリーンショット・トゥ・コードの仕組み',
    steps: [
      {
        title: 'スクリーンショットをドロップする',
        body: '欲しい画面の画像をエージェントに渡します — アプリ、ウェブサイト、デザインのスクリーンショット。NamVu Design が適切なスキルを読み込むので、エージェントは単なるピクセルではなく、レイアウトと意図を読み取ります。',
    ...
    tableTitle: 'NamVu Design vs 一般的なスクリーンショット・トゥ・コードツール',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design でスクリーンショットから再構築',
    galleryLead:
    ...
    faq: [
      {
        q: 'NamVu Design はどうやってスクリーンショットをコードに変えますか？',
        a: 'コーディングエージェントに画面の画像を渡すと、NamVu Design が適切なスキルを読み込むので、エージェントはそれをきれいでコンポーネントベースのコードとして再構築します — 単にピクセルをなぞるのではなく、レイアウトと意図を読み取ります。',
      },
      {
        q: 'どんな種類のコードを生み出しますか？',
      ...
      {
        q: '無料ですか？',
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — スクリーンショット・トゥ・コードのワークフロー自体にシート単位やクレジット単位の課金はありません。',
      },
      {
        q: 'どのエージェントで動きますか？',
        a: 'NamVu Design は Claude Code、Codex、Cursor Agent、Gemini CLI、その他十数種のファーストパーティアダプターで動作します。プロバイダーの鍵は自分で持ち込み、何もホストされません。',
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、欲しい画面のスクリーンショットを、すでに使っているエージェントの中で、きれいで出荷できるコードに変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/figma-to-code/', label: 'NamVu Design で Figma からコードへ' },
      { href: '/solutions/design-to-code/', label: 'NamVu Design でデザインからコードへ' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI ジェネレーター' },
      { href: '/solutions/engineering/', label: 'エンジニアリングのための NamVu Design' },
    ],
  ...
  htmlToPpt: {
    title: 'HTML to PPT — NamVu Design で HTML を編集可能な PowerPoint に変える',
    description:
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'ほとんどの HTML-to-PPT コンバーターは、ページを編集できない静的なスライド画像に潰してしまいます。NamVu Design はコーディングエージェントの中で資料を HTML として組み立て、本物の編集可能な .pptx をエクスポートします。ネイティブなテキストと図形、あなたのデザインシステム、シート単位の課金なし、ベンダーロックなし。',
    stepsTitle: 'HTML to PPT の仕組み',
    steps: [
      {
        title: 'HTML、ドキュメント、またはプロンプトから始める',
        body: 'エージェントに HTML ページ、markdown ドキュメント、あるいは資料の説明を渡します。NamVu Design が適切なスキルを読み込み、エージェントは生のマークアップだけでなく、見出し・セクション・データといった構造と意図を読み取ります。',
      ...
      },
      {
        ...
        body: 'NamVu Design の pptx-generator が HTML 資料を本物の PowerPoint に変換します。ネイティブな図形、編集可能なテキスト、変更し続けられるチャートを備え、スライドごとのフラットな画像ではなく HTML-to-PPTX の忠実度を監査します。',
    ...
    tableTitle: 'NamVu Design と一般的な HTML-to-PPT コンバーターの比較',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryLead:
      'NamVu Design がレンダリングした本物の資料で、編集可能な .pptx にエクスポートできる状態です。コンテンツに近いテーマを選び、あなたのバリエーションを説明すると、エージェントが資料を組み立て、所有できる PowerPoint を手渡します。',
    gallery: [
    ...
    faq: [
      {
        q: 'NamVu Design はどうやって HTML を PPT に変えますか？',
        a: 'コーディングエージェントがコンテンツをきれいな HTML 資料に組み立て、次に NamVu Design の pptx-generator スキルがそれを本物の編集可能な .pptx にエクスポートします。スライドごとのフラットな画像ではなく、ネイティブな図形とテキストで、HTML-to-PPTX の忠実度を監査済みです。',
      },
      {
      ...
      {
        q: '無料ですか？',
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で自分の鍵を使って動きます。HTML-to-PPT ワークフローにファイル単位・クレジット単位の課金はありません。',
      },
      {
        q: 'スライドを生成することとの違いは何ですか？',
        a: '資料の生成はふつうプロンプトやアウトラインから始まりますが、HTML to PPT はすでに手元にある HTML や markdown から始まり、編集可能な .pptx エクスポートに重点を置きます。どちらも同じ NamVu Design の資料エンジンを使います。アウトラインを起点とするフローについてはスライドのユースケースをご覧ください。',
      },
    ],
    ctaTitle: '次の HTML 資料を編集可能な PPT に変える',
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、HTML — あるいはプロンプト — を、すでに使っているエージェントの中で、きれいな資料と本物の編集可能な .pptx に変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    lead: 'フローを説明するだけで、エージェントが本物でクリック可能なプロトタイプを生成します — リンクされた画面、一貫したスタイル、動作するインタラクション。モックアップで止まるプロトタイプジェネレーターとは違い、NamVu Design は同じ成果物を、すでに動かしているエージェントの中で出荷できるコードまで運びます。',
    heroImageAlt:
      'プロンプトが、クリック可能なマルチスクリーンのプロトタイプになり、さらに本番コードへと変わる様子を、緑の選択ボックスで囲って描いたエディトリアルなイラスト',
    tldrTitle: '一言で言うと',
    tldrBody:
      'たいていの AI プロトタイプジェネレーター（Figma、Cursor、Penpot）は、その後あなたが作り直すクリック可能なモックアップで止まります。NamVu Design はプロトタイプをコーディングエージェントの中で生成し、プロンプトから出荷できるコードまで運びます — エクスポート工程も、引き継ぎの断絶も、シート単位の課金もありません。',
    stepsTitle: 'AI プロトタイプジェネレーターの仕組み',
    steps: [
      {
        title: 'フローを説明する',
        body: 'その道のりを普通の言葉でエージェントに伝えます — 「オンボーディングフロー：サインアップ、プラン選択、そしてダッシュボード」のように。NamVu Design がプロトタイプスキルを読み込むので、エージェントは単一の静止フレームではなく、リンクされた画面をレイアウトします。',
    ...
    tableTitle: 'NamVu Design vs 一般的な AI プロトタイプジェネレーター',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られたプロトタイプ',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'はい。NamVu Design はオープンソースで、あなたがすでに使っているコーディングエージェントの中で、自分のプロバイダーの鍵を使って動きます — プロトタイプジェネレーター自体にシート単位やクレジット単位の課金はありません。',
      },
      {
        q: 'Figma、Cursor、Penpot のプロトタイプジェネレーターと何が違いますか？',
        a: 'それらは彼らのアプリの中のクリック可能なモックアップで止まります。NamVu Design はプロトタイプをあなたのコーディングエージェントの中で生成し、同じ成果物を、あなたが所有する出荷できるコードまで運びます — エクスポートも、本番用の作り直しもありません。',
      },
      {
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次のフローを、すでに使っているエージェントの中で、クリック可能なプロトタイプに — そして出荷できるコードに — 変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/prototype/', label: 'NamVu Design でのプロトタイピング' },
      { href: '/solutions/ai-wireframe-generator/', label: 'AI ワイヤーフレームジェネレーター' },
  ...
  prototype: {
    title: 'NamVu Design + Claude Code でインタラクティブなプロトタイプを作る',
    description:
      'プロンプトを、ターミナルから離れることなくクリック可能なマルチスクリーンのプロトタイプに変えます。NamVu Design はコーディングエージェントに、デザインスキル、テンプレート、デザインシステムを与え、ブラウザで開ける本物のプロトタイプを出力します。',
    breadcrumb: 'プロトタイプ',
    label: 'ユースケース · プロトタイプ',
    ...
    tldrTitle: '一言で言うと',
    tldrBody:
      'NamVu Design は、あなたがすでに使っているコーディングエージェントのためのデザインレイヤーです。プロトタイピングにおいては、一段落のアイデアから、操作可能でスタイルの整ったプロトタイプを一度のセッションで生み出せるということ。デザインツールも、エクスポート工程も、引き継ぎの断絶もありません。',
    stepsTitle: 'NamVu Design でのプロトタイピングの流れ',
    steps: [
      {
        title: 'フローを説明する',
        body: '作りたいものを普通の言葉で伝えます。「ウェルカム画面、プラン選択、確認画面のあるオンボーディングフロー」のように。NamVu Design がプロトタイプスキルを読み込み、エージェントは単一ページではなく複数の画面を生み出すべきだと理解します。',
        imageAlt:
          'アプリフローの説明を普通の言葉でターミナルに打ち込む人物のイラスト',
      },
      {
        title: 'スタイル付きの画面を生成する',
        body: 'エージェントは NamVu Design のデザインシステムとプロトタイプテンプレートを適用するため、どの画面もタイポグラフィ、余白、コンポーネントを共有し、ラフな下書きには見えません。バラバラのモックアップではなく、まとまりのある画面群が手に入ります。',
        imageAlt:
    ...
    tableTitle: 'NamVu Design でのプロトタイピング vs これまでのやり方',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    faq: [
      {
        q: 'NamVu Design でプロトタイプを作るのに Figma のようなデザインツールは必要ですか？',
        a: 'いいえ。NamVu Design はコーディングエージェントの中で動き、プロトタイプを HTML にレンダリングします。フローを言葉で説明すれば、エージェントが画面を生み出します。学んだり料金を払ったりする別のキャンバスツールはありません。',
      },
      {
      ...
      {
        q: 'どのエージェントを使えますか？',
        a: 'NamVu Design は Claude Code、Codex、Cursor Agent、Gemini CLI、その他10種以上のファーストパーティアダプターで動作します。プロバイダーの鍵は自分で持ち込み、何もホストされません。',
      },
      {
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次の「もし〜だったら」を、すでに使っているエージェントの中で、クリックできる形に変えましょう。',
  },
  dashboard: {
    title: 'NamVu Design + Claude Code でデータダッシュボードを生成する',
    description:
    ...
    lead: '何を見せたいか、どう感じさせたいかをエージェントに伝えます。NamVu Design がチャートのパターン、レイアウトシステム、ビジュアル言語を供給するので、デフォルトスタイルのウィジェットの壁ではなく、まとまりのある見栄えの良いダッシュボードが手に入ります。',
    heroImageAlt:
      '左側の生の数値が、右側のチャートと KPI カードのきれいなダッシュボードへと流れ込むエディトリアルなイラスト',
    tldrTitle: '一言で言うと',
    tldrBody:
      'NamVu Design は指標を普通の言葉で書いた仕様を、エージェントが HTML にレンダリングするスタイルの整ったダッシュボードに変えます。リポジトリでバージョン管理され、どこにでもホストでき、シート単位の BI サブスクは不要です。',
    stepsTitle: 'NamVu Design でのダッシュボードの流れ',
    steps: [
      {
        title: '指標を説明する',
      ...
      {
        title: 'チャートのパターンを選ぶ',
        body: 'NamVu Design はチャートとレイアウトのテンプレートを備えているので、トレンドは折れ線グラフに、内訳は棒グラフに、比率は適切なビジュアルになります。ちぐはぐなデフォルトではなく、一貫したタイポグラフィと余白が全体を通ります。',
    ...
    tableTitle: 'NamVu Design でのダッシュボード vs これまでのやり方',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られたダッシュボード',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'いいえ。NamVu Design はコーディングエージェントの中でダッシュボードを HTML にレンダリングします。指標を説明してデータに向けるだけで、ライセンスや習得が必要な別の BI プラットフォームはありません。',
      },
      {
        q: 'データはどこから来ますか？',
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、あなたの指標を、すでに使っているエージェントの中で、どこにでもホストできるダッシュボードに変えましょう。',
  },
  slides: {
    title: 'NamVu Design + Claude Code でプレゼンテーション資料を生成する',
    description:
      'アウトラインを、プレゼンアプリを開かずにデザインされたブランドに沿ったスライド資料に変えます。NamVu Design はコーディングエージェントに資料テンプレートとビジュアルシステムを与え、プレゼン・エクスポート・共有できる HTML にスライドをレンダリングします。',
    breadcrumb: 'スライド',
    label: 'ユースケース · スライド',
    heading: 'デザインされて見える資料を、プロンプトで書く',
    lead: 'エージェントにアウトラインとトーンを渡します。NamVu Design が資料テンプレートとビジュアルシステムを適用するので、どのスライドもレイアウトされ、組版され、ブランドに沿います。空白の背景に箇条書きが並ぶだけではありません。',
    heroImageAlt:
      '左側のアウトラインが、右側のデザインされたプレゼンスライドの連なりに変わるエディトリアルなイラスト',
    tldrTitle: '一言で言うと',
    tldrBody:
      'NamVu Design はアウトラインを、エージェントが一度のセッションでレンダリングするデザインされた HTML 資料に変えます。ブラウザでプレゼンし、PDF や PPTX にエクスポートし、ソースはリポジトリに保持できます。',
    stepsTitle: 'NamVu Design での資料作成の流れ',
    steps: [
      {
        title: 'アウトラインを渡す',
      ...
      {
        title: '資料のスタイルを選ぶ',
        body: 'NamVu Design は資料テンプレートを備えています — エディトリアル、スイス・インターナショナル、ダークなテクニカルなど。エージェントが一つを適用し、タイポグラフィ、グリッド、アクセントがすべてのスライドで一貫します。',
    ...
    tableTitle: 'NamVu Design での資料 vs これまでのやり方',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られた資料',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'いいえ。NamVu Design はコーディングエージェントの中で資料を HTML にレンダリングし、PDF や PPTX にエクスポートできます。ブラウザからプレゼンするかファイルを渡すだけで、作るためにプレゼンアプリは要りません。',
      },
      {
      ...
      },
      {
        ...
        a: 'はい。NamVu Design の pptx-generator が資料を本物の .pptx にエクスポートします。ネイティブで編集可能なテキストと図形を備え、フラットなスライド画像ではなく HTML-to-PPTX の忠実度を監査済みです。加えて PDF と、プレゼン元となる HTML も得られます。変換を起点とするフローについては HTML to PPT ツールをご覧ください。',
      },
      {
        q: 'どのエージェントを使えますか？',
    ...
    ctaTitle: '次の資料を今夜作る',
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、あなたのアウトラインを、すでに使っているエージェントの中で、デザインされた資料に変えましょう。',
    relatedTitle: '関連ツールとガイド',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'NamVu Design で HTML から PPT へ' },
      { href: '/solutions/design-to-code/', label: 'NamVu Design でデザインからコードへ' },
      { href: '/plugins/templates/', label: '資料テンプレートを見る' },
      { href: '/solutions/marketing/', label: 'マーケティングのための NamVu Design' },
    ],
  ...
  image: {
    title: 'NamVu Design + Claude Code でブランドに沿ったグラフィックを生成する',
    description:
    ...
    lead: '必要なカードやカバーを説明します。NamVu Design が本物の文字組み、グリッド、ブランドカラーで構成し、画像としてエクスポートできる HTML にレンダリングします。デザインアプリと格闘したり、ありきたりなテンプレートを使ったりする必要はありません。',
    heroImageAlt:
      'プロンプトが、レイアウトされたソーシャルカードと記事カバーの一式に変わるエディトリアルなイラスト',
    tldrTitle: '一言で言うと',
    tldrBody:
      'NamVu Design はプロンプトを、エージェントが HTML にレンダリングして PNG にエクスポートする、組版されたブランドに沿ったグラフィックに変えます。繰り返し可能で、バージョン管理され、シート単位のデザインツールから解放されます。',
    stepsTitle: 'NamVu Design でのグラフィック作成の流れ',
    steps: [
      {
        title: 'グラフィックを説明する',
      ...
      {
        title: 'ブランドシステムを適用する',
        body: 'NamVu Design があなたの色、文字組み、余白を再利用可能なデザインシステムから引き出すので、どのカードも一度きりのものに見えるのではなく、ブランドの他の部分と揃います。',
    ...
    tableTitle: 'NamVu Design でのグラフィック vs これまでのやり方',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られたグラフィック',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'いいえ。NamVu Design は本物のレイアウトとタイポグラフィでグラフィックを構成します — あなたの見出し、あなたのブランド、ちょうどの寸法で — そして PNG としてエクスポートする HTML にレンダリングします。ピクセル生成ではなく、デザインの構成です。',
      },
      {
        q: '一貫した一連のカードを作れますか？',
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、プロンプトを、すでに使っているエージェントの中で、ブランドに沿ったグラフィックに変えましょう。',
  },
  video: {
    title: 'NamVu Design + Claude Code でモーショングラフィックとショート動画を生成する',
    description:
    ...
    lead: '欲しい瞬間を説明します — タイトルの登場、データのアニメーション、ロゴのアウトロ。NamVu Design があなたのブランドシステムでアニメーションフレームを構成し、動画にレンダリングします。モーショングラフィックスイートは要りません。',
    heroImageAlt:
      'スクリプトが、アニメーションする動画フレームの連なりに変わるエディトリアルなイラスト',
    tldrTitle: '一言で言うと',
    tldrBody:
      'NamVu Design はスクリプトを、エージェントがショート動画にレンダリングする、アニメーションするブランドに沿ったフレームに変えます。HTML から構成され、リポジトリでバージョン管理され、習得すべきタイムラインエディターはありません。',
    stepsTitle: 'NamVu Design でのモーションの流れ',
    steps: [
      {
        title: '瞬間を説明する',
      ...
      },
      {
        ...
        body: 'NamVu Design がフレームテンプレートを供給します — 映画的なライトリーク、グリッチのタイトル、ロゴのアウトロ — そしてあなたの色と文字組みを適用するので、モーションは意図的でブランドに沿って見えます。',
    ...
    tableTitle: 'NamVu Design でのモーション vs これまでのやり方',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design で作られたモーション',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'いいえ。NamVu Design はコーディングエージェントの中でアニメーションフレームを HTML で構成し、動画にレンダリングします。習得やライセンスが必要なタイムラインエディターはありません。',
      },
      {
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、スクリプトを、すでに使っているエージェントの中で、モーションに変えましょう。',
  },
  designSystem: {
    title: 'NamVu Design + Claude Code でデザインシステムを構築し適用する',
    description:
    ...
    lead: 'ブランドを一度定義すれば、NamVu Design がそれをすべての出力に持ち込みます — プロトタイプ、資料、ダッシュボード、グラフィック。システムはエージェントが読む DESIGN.md としてリポジトリ内にあるので、一貫性は手作業ではなく自動です。',
    heroImageAlt:
      '一つのデザインシステムが、多くのブランドに沿った成果物へと放射状に広がるエディトリアルなイラスト',
    tldrTitle: '一言で言うと',
    tldrBody:
      'NamVu Design はブランドを、エージェントがあらゆる成果物に適用する持ち運び可能なデザインシステムとして捉えます — リポジトリ内で一度定義し、どこでも強制され、それを管理する中央のデザインツールはありません。',
    stepsTitle: 'NamVu Design でのデザインシステムの流れ',
    steps: [
      {
        title: 'システムを捉える',
        body: 'ブランドを説明します — 色、文字組み、余白、声 — または既存のサイトをエージェントに指して抽出させます。NamVu Design がそれをプロジェクト内にある DESIGN.md に書き込みます。',
        imageAlt: 'ブランドが一つのデザインシステムファイルに捉えられるイラスト',
      },
      {
        title: '実証済みのベースから始める',
        body: 'NamVu Design は140以上の参照デザインシステムを備えています — Apple や Linear からエディトリアル、ブルータリストまで。白紙から始めるのではなく、自分のブランドに近いものをフォークしましょう。',
    ...
    tableTitle: 'NamVu Design でのデザインシステム vs これまでのやり方',
    tableColCapability: '必要なこと',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design のデザインシステム',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: '色、文字組み、余白、コンポーネント、声を捉えた、リポジトリ内の DESIGN.md ファイルです。NamVu Design のすべてのスキルがそれを読むので、あなたのブランドがエージェントの生み出すものに自動的に適用されます。',
      },
      {
        q: 'ゼロから始めなければなりませんか？',
        a: 'いいえ。NamVu Design はフォークできる140以上の参照デザインシステムを備えています — Apple や Linear からエディトリアル、ブルータリストまで — そこから自分のブランドに適応させます。',
      },
      {
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、すでに使っているエージェントに、どこにでも適用できる一つのブランドを与えましょう。',
  },
  roleSoloBuilder: {
    title: 'ソロビルダーとインディーハッカーのための NamVu Design',
    description:
      '一人でもチームのように出荷しよう。NamVu Design はあなたのコーディングエージェントを、スタートアップのデザイン担当に変えます。プロトタイプ、ランディングページ、ダッシュボード、ブランドビジュアルまで、すべてプロンプトから、すべてブランドに沿って、すべてあなたのリポジトリの中で。',
    breadcrumb: 'ソロビルダー',
    label: '対象 · ソロビルダー',
    ...
    tldrTitle: 'ひと言で言うと',
    tldrBody:
      'NamVu Design は、ソロ創業者がこれまで持てなかったデザイン部門です。プロダクトに必要なあらゆる面で、プロンプトから成果物へ。ひとつのブランドで、引き継ぎゼロ、追加ツールなし。',
    stepsTitle: 'ソロビルダーは NamVu Design をこう使う',
    steps: [
      {
        title: 'ブランドを一度だけ定義する',
    ...
    tableTitle: 'NamVu Design でのソロ開発 vs. 手作業でやり抜く道',
    ...
    galleryTitle: 'NamVu Design で一人で作った',
    galleryLead:
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、一つのエージェントをあなたのデザインチームにしよう。すでに使っているそのエージェントの中で。',
  },
  roleDesigner: {
    title: 'デザイナーのための NamVu Design',
    description:
      '時間をセンスに使い、雑務には使わない。NamVu Design は、繰り返しの制作作業（バリエーション、状態、デザインシステム全体）をエージェントに任せ、あなたは見た目をディレクションし、最終判断を握ります。',
    breadcrumb: 'デザイナー',
    label: '対象 · デザイナー',
    ...
    tldrTitle: 'ひと言で言うと',
    tldrBody:
      'NamVu Design は決して疲れない制作アシスタントです。あなたがデザインシステムを定義しセンスを判断し、エージェントが残りをシステムに沿って、あなたのリポジトリの中で生成します。',
    stepsTitle: 'デザイナーは NamVu Design をこう使う',
    steps: [
      {
        title: 'システムをコード化する',
    ...
    tableTitle: 'NamVu Design でのデザイン vs. 手作業のやり方',
    tableColCapability: '必要なもの',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'NamVu Design でディレクションした',
    galleryLead:
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、制作はエージェントに任せ、センスはあなたが判断しよう。すでに使っているそのエージェントの中で。',
  },
  roleEngineering: {
    title: 'エンジニアのための NamVu Design',
    description:
      'デザインの引き継ぎを飛ばそう。NamVu Design は DESIGN.md を、あなたのコーディングエージェントが直接書く本物のフロントエンドに変えます。システムに沿った UI、プロトタイプ、ダッシュボードを、リポジトリの中で、Figma の往復なしに。',
    breadcrumb: 'エンジニアリング',
    label: '対象 · エンジニアリング',
    ...
    tldrTitle: 'ひと言で言うと',
    tldrBody:
      'NamVu Design はデザインシステムを機械可読にすることで、デザイナーからエンジニアへのギャップを埋めます。あなたのコードを書く同じエージェントが、システムを適用し本物の UI をレンダリングします。',
    stepsTitle: 'エンジニアは NamVu Design をこう使う',
    steps: [
      {
    ...
    tableTitle: 'NamVu Design でのフロントエンド vs. 引き継ぎのやり方',
    tableColCapability: '必要なもの',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'エンジニアが NamVu Design で作った',
    galleryLead:
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、DESIGN.md をフロントエンドに変えよう。すでに使っているそのエージェントの中で。',
  },
  roleProductManagers: {
    title: 'プロダクトマネージャーのための NamVu Design',
    description:
      'アイデアを伝えるために、デザインのリソースを待つのはもう終わり。NamVu Design は PM がプロンプトを、クリック可能なプロトタイプやワイヤーフレームに変えられるようにします。ステークホルダーの足並みを揃え、チームにブリーフィングするために、デザインチケットなしで。',
    ...
    tldrTitle: 'ひと言で言うと',
    tldrBody:
      'NamVu Design は PM にデザイン不要の方法でアイデアを形にする手段を与えます。足並みを揃えるためのブリーフのための、プロンプトからプロトタイプへ。チームのデザイン予算を使わずに。',
    stepsTitle: 'PM は NamVu Design をこう使う',
    steps: [
      {
        title: 'フローを説明する',
    ...
    tableTitle: 'NamVu Design での PM 業務 vs. デザイン待ち',
    tableColCapability: '必要なもの',
    tableColWithOd: 'NamVu Design なら',
    ...
    galleryTitle: 'PM が NamVu Design でプロトタイプ化した',
    galleryLead:
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、次の仕様を人がクリックできるものに変えよう。すでに使っているそのエージェントの中で。',
  },
  roleMarketing: {
    title: 'マーケティングチームのための NamVu Design',
    description:
      'コンテンツのスピードでキャンペーンを出荷しよう。NamVu Design はあなたのエージェントが、ランディングページ、ソーシャルカード、キャンペーンビジュアルをプロンプトから作れるようにします。ブランドに沿って、オンデマンドで、デザインの順番待ちなしに。',
    breadcrumb: 'マーケティング',
    label: '対象 · マーケティング',
    ...
    tldrTitle: 'ひと言で言うと',
    tldrBody:
      'NamVu Design はマーケティングの常時稼働のデザインリソースです。ランディングページとソーシャルのための、プロンプトからアセットへ。ブランドに沿って。だからキャンペーンはコピーを書くスピードで出荷されます。',
    stepsTitle: 'マーケティングチームは NamVu Design をこう使う',
    steps: [
      {
        title: 'ブランドを固める',
    ...
    tableTitle: 'NamVu Design でのマーケティング vs. いつものドタバタ',
    tableColCapability: '必要なもの',
    tableColWithOd: 'NamVu Design なら',
    tableColWithout: '今、それなしだと',
    tableRows: [
    ...
    galleryTitle: 'マーケティングが NamVu Design で出荷した',
    galleryLead:
    ...
    ctaBody:
      'リポジトリにスターを付け、NamVu Design をインストールして、ブリーフをブランドに沿ったアセットに変えよう。すでに使っているそのエージェントの中で。',
  },
};

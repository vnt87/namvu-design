...
export type CodexSlidesCopy = {
  ...
  heading: string;
  lead: string;
  /** Primary CTA label. Names NamVu Design explicitly (this is a sister-product
...
const EN: CodexSlidesCopy = {
  ...
  downloadCta: 'Download NamVu Design',
  heroAlt:
  ...
  tiebackTitle: 'Part of the NamVu Design family',
  tiebackBody:
    'NamVu Design is the open, local-first design workspace that sits outside the coding agent you already use. Codex Slides is that same idea aimed at presentations: your agent does the work in the open, the project stays on your machine, and nothing is locked behind a subscription. For the full design toolkit beyond slides, get the NamVu Design app.',
  ...
  schemaRelationQuestion: 'Is Codex Slides related to NamVu Design?',
  schemaRelationAnswer:
    'Yes. Codex Slides is a sister project from the team behind NamVu Design, the same open, local-first, agent-native approach applied to presentations instead of design files.',
};

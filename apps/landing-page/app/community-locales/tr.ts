...
const tr: DeepPartial<CommunityCopy> = {
  hub: {
    title: "Topluluk — NamVu Design",
    desc: "NamVu Design topluluğu: herkesin gözü önünde iş çıkaran katkıcılar, yerel atölyeler düzenleyen elçiler ve Discord'u sıcak tutan moderatörler.",
    heroTitle: "Açık tasarım <em>şekillenir</em><br/>onu siz yayımlayınca.",
    heroLead:
      "NamVu Design herkesin gözü önünde, insanlar tarafından inşa ediliyor. Skill'ler, DESIGN.md sistemleri, plugin'ler, dokümanlar: her commit bir fırça darbesi. Aşağıdan bir kapı seçin, kendi odanızı bulun.",
    cardMetaH: "İlk merge'de otomatik basılır",
    cardMetaS: "PNG · X'te paylaşılır",
    cardHeroAlt:
      "NamVu Design katkıcı onur kartı — @dev-kp-eloper, en iyi %99,9, Giotto kademesi",
    cards: [
      {
        ord: "I",
        title: "Katkıcılar",
      ...
      },
      {
        ord: "II",
        title: "Elçiler",
        sub: "Şehrinizde NamVu Design'ın <em>sesi</em>.",
  ...
  contributors: {
    title: "Katkıcılar — NamVu Design",
    desc: "NamVu Design'a katkıda bulunun: maintainer'lar, haftalık ve tüm zamanların katkıcı liderlik tabloları, good first issue'lar ve ilk eserinizi yayımlamak için sıfır kod yolu.",
    heroTitle: "İşi <em>yayımlayan</em> eller.",
    heroLead:
      "NamVu Design herkesin gözü önünde, insanlar tarafından inşa ediliyor. Skill'ler, DESIGN.md sistemleri, plugin'ler, dokümanlar: her commit bir fırça darbesi. Bir issue seçin, bir PR gönderin ve merge edildiğiniz an eşi benzeri olmayan bir onur kartı kazanın.",
    showcase: {
      kicker: "Her şeyi plugin yap",
      h2: "Sahne olarak NamVu Design. Gösteri olarak <em>sizin işiniz</em>.",
      intro:
        ...
        steps: [
          {
            ...
            body: "Yukarıdaki komutu NamVu Design içindeki ajana ya da zaten elinizin altında tuttuğunuz herhangi birine yapıştırın: Claude Code, Codex, Cursor. Kendini kurar.",
          },
          {
    ...
    maintainers: {
      ...
      intro:
        "Maintainer'lar NamVu Design'ın yönünü ve kalitesini korur: katkıları inceler, standardı tutarlı tutar ve daha fazla katkıcının projede yerini kazanmasına alan açar.",
      role: "Maintainer",
      bios: {
        "Nagendhra-web":
          "Nagendhra, üretim gerçeğine dair bir veri mühendisinin içgüdüsünü getiriyor: hatayı bul, uç durumu ölç ve düzgünce düzelt. NamVu Design'da bu; deploy ön kontrol çalışmalarında, asset paketleme sağlamlaştırmasında ve katkıcılar iş yayımladığında projeyi güvenilir hissettiren Windows düzeltmelerinde kendini gösteriyor.",
        "Sid-Qin":
          "Sid, bir tasarımcının detay gözüne sahip çok yönlü mühendis: hem bozuk CLI yolunu hem de eğri duran etkileşim öğesini fark eden türden bir maintainer. NamVu Design'da Sid; export akışlarını, plugin eylemlerini, Windows shim'lerini, MIME işlemeyi ve ajan altyapısını bir topluluğun üzerine inşa edebileceği kadar keskin tutuyor.",
      },
    },
    allTime: {
      ...
      intro:
        "Fikirleri, düzeltmeleri ve zanaati ortak NamVu Design standardına dönüştürmeyi sürdüren yetenekli katkıcıların uzun soluklu bir kaydı.",
    ...
    weekly: {
      ...
      intro:
        "PR'lar merge eden, ürünü geliştiren ve NamVu Design'ı canlı hissettiren keskin katkıcıların anlık görüntüsü.",
      rankLabel: "Bu haftanın lideri",
      week: "Son 7 gün",
      handleSuffix: "· bu hafta önde",
      blurbTemplate:
        "{name} bu hafta {prs} merge edilmiş PR ve NamVu Design'ı hareket halinde tutan istikrarlı zanaatiyle tempoyu belirliyor.",
      statRank: "Sıra",
      statPrs: "PR · 7g",
      headContributor: "Katkıcı",
      headPrs: "PR",
    ...
    issues: {
      ...
      intro:
        'NamVu Design deposundaki <span class="num">label:&ldquo;good first issue&rdquo;</span> etiketinden canlı olarak. Bir issue üzerine yorum yaparak onu üstlenin; bir maintainer bir gün içinde size atayacaktır.',
  ...
  ambassadors: {
    title: "Elçiler — NamVu Design",
    desc: "NamVu Design elçisi olun: yerel bir atölye açın, buluşmalar ve eleştiriler düzenleyin; bütçe, materyal ve çekirdek ekibe özel bir kanal edinin.",
    heroTitle: "Şehrinizde NamVu Design'ın <em>sesi</em> olun.",
    heroLead:
    ...
    program: {
      ...
      applyNote:
        "Elçiler, NamVu Design'ı bir depodan; katkıcıların masada mürekkep ve soğumuş kahveyle bir odada buluşabileceği bir şeye dönüştürür.",
      cols: [
        {
          n: "I · Meslek",
    ...
    roster: {
      ...
      intro:
        "NamVu Design'ın daha fazla tasarımcı ve ekibe ulaşmasına yardım eden yerel organizatörler, üreticiler ve topluluk kurucuları.",
      places: [
  ...
  moderators: {
    title: "Moderatörler — NamVu Design",
    desc: "NamVu Design Discord moderatörleriyle tanışın ve AI-native tasarımcıların iş yayımladığı, plugin açtığı, betaları test ettiği ve birbirini takılıp kaldığı yerden çıkardığı odaya katılın.",
    ...
    discord: {
      ...
      cards: [
        {
          role: "Stüdyodan",
          bio: "NamVu Design kurucu ekibinden. Discord'un takılmak için güzel bir yer olarak kalmasını umuyor. İstediğiniz zaman, her soru için el sallayın.",
        },
        {
          role: "Odanın yöneticisi",
          bio: "Discord ve topluluk bakımında deneyimli bir el. Odayı sıcak, kapıları açık, sohbeti akışkan tutar. NamVu Design tutkunu.",
        },
      ],

...
const en: HomeCopy = {
  ...
  aboutCaptionCredit: '(NamVu Design, MMXXVI)',
  ...
  testimonialQuotePre: '“NamVu Design helped us turn vague',
...
const zhCN: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '“NamVu Design 帮我们把模糊的',
...
const ja: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '「NamVu Design は私たちの曖昧な',
...
const ko: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '"NamVu Design 은 우리의 모호한',
...
const zhTW: Partial<HomeCopy> = {
  ...
  testimonialLabel: '合作者 · Nº 06',
  testimonialQuotePre: '「NamVu Design 幫我們把模糊的',
  testimonialQuoteEm1: 'AI 想法',
...
const de: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '„NamVu Design hat uns geholfen, vage',
...
const fr: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '« NamVu Design nous a aidés à transformer de vagues',
...
const esES: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '«NamVu Design nos ayudó a convertir',
...
const ptBR: Partial<HomeCopy> = {
  ...
  testimonialLabel: 'Colaboradores · Nº 06',
  testimonialQuotePre: '"O NamVu Design nos ajudou a transformar',

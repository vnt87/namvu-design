...
const EN: TeamPricingContent = {
  metaTitle: 'Pricing — NamVu Design',
  metaDescription:
    'Compare NamVu Design Creator and Team plans, including model credits, per-seat collaboration, annual savings, and Enterprise support.',
...
const ZH: TeamPricingContent = {
  metaTitle: '价格方案 — NamVu Design',
  metaDescription:
    '比较 NamVu Design 创作会员与团队版方案，了解模型额度、按席位协作、年付优惠和企业支持。',
...
const JA: TeamPricingContent = {
  metaTitle: '料金プラン — NamVu Design',
  metaDescription:
    'NamVu Design のクリエイター向けプランと Team プランを比較。モデルクレジット、席単位の共同作業、年払い割引、Enterprise サポートを確認できます。',
...
const KO: TeamPricingContent = {
  metaTitle: '요금제 — NamVu Design',
  metaDescription:
    'NamVu Design 크리에이터 및 Team 요금제의 모델 크레딧, 좌석 기반 협업, 연간 할인과 Enterprise 지원을 비교하세요.',
  breadcrumbLabel: '요금제',
...
const DE: TeamPricingContent = {
  metaTitle: 'Preise — NamVu Design',
  metaDescription:
    'Vergleiche NamVu Design Creator- und Team-Pläne mit Modellguthaben, Zusammenarbeit pro Sitz, Jahresrabatten und Enterprise-Support.',
...
const FR: TeamPricingContent = {
  metaTitle: 'Tarifs — NamVu Design',
  metaDescription:
    'Comparez les offres Creator et Team d’NamVu Design : crédits modèles, collaboration par siège, réductions annuelles et support Enterprise.',
...
const RU: TeamPricingContent = {
  metaTitle: 'Тарифы — NamVu Design',
  metaDescription:
    'Сравните тарифы NamVu Design для авторов и команд: кредиты моделей, совместная работа по местам, годовые скидки и поддержка Enterprise.',
...
const ES: TeamPricingContent = {
  metaTitle: 'Precios — NamVu Design',
  metaDescription:
    'Compara los planes Creator y Team de NamVu Design: créditos de modelos, colaboración por asiento, ahorro anual y soporte Enterprise.',
...
const PT_BR: TeamPricingContent = {
  metaTitle: 'Preços — NamVu Design',
  metaDescription:
    'Compare os planos Creator e Team do NamVu Design, com créditos de modelos, colaboração por assento, economia anual e suporte Enterprise.',
...
const IT: TeamPricingContent = {
  metaTitle: 'Prezzi — NamVu Design',
  metaDescription:
    'Confronta i piani Creator e Team di NamVu Design: crediti modello, collaborazione per postazione, risparmio annuale e supporto Enterprise.',
...
const TR: TeamPricingContent = {
  metaTitle: 'Fiyatlandırma — NamVu Design',
  metaDescription:
    'NamVu Design Creator ve Team planlarını; model kredileri, koltuk başına iş birliği, yıllık tasarruf ve Enterprise desteğiyle karşılaştırın.',

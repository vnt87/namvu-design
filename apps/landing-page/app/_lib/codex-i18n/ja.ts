...
export const ja: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex は動くコードを書く。ただ放っておけば、無難なフォント、平凡な余白、中央寄せの Helvetica に落ち着く。ここに集めたのは Codex にセンスを与えるプラグイン、つまり美意識のスキルとデザインシステムのルール。ひとつだけ入れてもいいし、NamVu Design の中でまとめて動かしてもいい。',
  collectionStats: [
  ...
  collectionCloserHeading: 'セットアップは飛ばして、NamVu Design の中で Codex とデザインする',
  filterAll: 'すべて',
  collectionCloserBody:
    'NamVu Design は、Codex を包み込むように動くオープンソースのエージェントネイティブなデザインワークスペースです。デザインシステム、スキル、テンプレートの一貫性を保つので、エージェントが仕上げた成果物はあなたのものになります。',
  categoryFrontend: 'フロントエンド & UI',
  categoryDesignSystems: 'デザインシステム',
  ctaDownload: 'NamVu Design をダウンロード',
  ...
  finalEyebrow: '次のステップ',
  detailCloserHeading: 'セットアップなしで、NamVu Design とデザインする',
  detailCloserBody:
    'このプラグインを自分で入れてもいいし、NamVu Design でキュレーション済みのデザインレイヤーごと Codex の周りで動かしてもいい。自分の API キーを使い、成果物も自分のものに。',
  skills: {
    'gpt-taste': {
      tagline:

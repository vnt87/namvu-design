...
export const ko: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex는 돌아가는 코드를 짭니다. 다만 그냥 두면 무난한 폰트, 평범한 여백, 가운데 정렬된 Helvetica로 흘러가죠. 여기 모은 것은 Codex에 안목을 심어 주는 플러그인 모음입니다. 미감을 잡아 주는 스킬과 디자인 시스템 규칙까지. 하나만 설치해도 되고, NamVu Design 안에서 전부 돌려도 됩니다.',
  collectionStats: [
  ...
  collectionCloserHeading: '세팅은 건너뛰세요. NamVu Design 안에서 Codex와 디자인하기',
  filterAll: '전체',
  collectionCloserBody:
    'NamVu Design은 Codex를 감싸고 도는 오픈소스 에이전트 네이티브 디자인 워크스페이스입니다. 시스템과 스킬, 템플릿을 일관되게 지켜 주므로 에이전트가 내놓는 결과물은 온전히 여러분의 것입니다.',
  categoryFrontend: '프런트엔드 & UI',
  categoryDesignSystems: '디자인 시스템',
  ctaDownload: 'NamVu Design 다운로드',
  ...
  finalEyebrow: '다음 단계',
  detailCloserHeading: '세팅 없이, NamVu Design으로 디자인하기',
  detailCloserBody:
    '이 플러그인을 직접 설치해도 되고, NamVu Design으로 Codex 주위에 잘 정돈된 디자인 레이어를 통째로 두를 수도 있습니다. 키는 직접 가져오고, 산출물도 직접 소유하세요.',
  skills: {
    'gpt-taste': {

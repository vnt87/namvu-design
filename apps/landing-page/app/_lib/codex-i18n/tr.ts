...
export const tr: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex çalışan kod yazar. Kendi haline bırakılırsa güvenli fontlara, ortalama boşluklara ve ortalanmış Helvetica’ya kaçar. Ona zevk kazandıran eklentiler bunlar: estetik skill’ler ve tasarım sistemi kuralları. Birini kurun ya da hepsini NamVu Design içinde çalıştırın.',
  collectionStats: [
  ...
  collectionCloserHeading: 'Kurulumu atlayın: Codex ile NamVu Design içinde tasarlayın',
  filterAll: 'Tümü',
  collectionCloserBody:
    'NamVu Design, Codex’in etrafında çalışan açık kaynaklı, agent-native tasarım çalışma alanıdır. Sistemlerinizi, skill’lerinizi ve şablonlarınızı tutarlı tutar; ajan da sahibi olduğunuz işi çıkarır.',
  categoryFrontend: 'Frontend & Arayüz',
  categoryDesignSystems: 'Tasarım Sistemleri',
  ctaDownload: 'NamVu Design’ı indir',
  ...
  detailCloserHeading: 'Kurulum derdi olmadan NamVu Design ile tasarlayın',
  detailCloserBody:
    'Bu eklentiyi kendiniz kurun ya da NamVu Design ile Codex’in etrafına baştan sona küratörlü bir tasarım katmanı geçirin. Kendi anahtarınızı getirin, çıktınızın sahibi olun.',
  skills: {
    'gpt-taste': {
      tagline:

...
export const de: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex schreibt funktionierenden Code. Sich selbst überlassen landet er bei sicheren Fonts, mittelmäßigen Abständen und zentrierter Helvetica. Diese Plugins geben ihm Geschmack: ästhetische Skills und Design-System-Regeln. Installiere eins davon, oder nutze alle in NamVu Design.',
  collectionStats: [
  ...
  collectionCloserHeading: 'Spar dir das Setup. Designe mit Codex in NamVu Design',
  filterAll: 'Alle',
  collectionCloserBody:
    'NamVu Design ist der quelloffene, agent-native Design-Workspace rund um Codex. Er hält Systeme, Skills und Templates konsistent, damit der Agent Arbeit liefert, die dir gehört.',
  categoryFrontend: 'Frontend & UI',
  categoryDesignSystems: 'Design-Systeme',
  ctaDownload: 'NamVu Design herunterladen',
  ...
  detailCloserHeading: 'Mit NamVu Design designen, ohne Setup',
  detailCloserBody:
    'Installiere dieses Plugin selbst, oder leg mit NamVu Design eine ganze kuratierte Design-Ebene um Codex. Eigener Key, eigenes Ergebnis.',
  skills: {
    'gpt-taste': {

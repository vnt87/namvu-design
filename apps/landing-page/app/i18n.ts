...
export interface HeaderCopy {
  ...
  starTitle: string;
  starPrefix: string;
  /** NamVu Design Cloud account entry — see header-enhancer.astro. */
  signIn: string;
...
const COMMON_COPY: Record<LandingLocaleCode, CommonCopy> = {
  en: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'Download NamVu Design desktop',
      downloadTitle: 'Download the desktop app',
      starAria: 'Star NamVu Design on GitHub',
  ...
  zh: {
    ...
    header: {
      ...
      download: '下载',
      downloadAria: '下载 NamVu Design 桌面端',
      downloadTitle: '下载桌面应用',
      starAria: '在 GitHub 为 NamVu Design 点 Star',
  ...
  'zh-tw': {
    ...
    header: {
      ...
      download: '下載',
      downloadAria: '下載 NamVu Design 桌面端',
      downloadTitle: '下載桌面應用',
      starAria: '在 GitHub 為 NamVu Design 按 Star',
  ...
  ja: {
    ...
    header: {
      ...
      download: 'ダウンロード',
      downloadAria: 'NamVu Design デスクトップをダウンロード',
      downloadTitle: 'デスクトップアプリをダウンロード',
      starAria: 'GitHub で NamVu Design にスター',
  ...
  ko: {
    ...
    header: {
      ...
      download: '다운로드',
      downloadAria: 'NamVu Design 데스크톱 다운로드',
      downloadTitle: '데스크톱 앱 다운로드',
      starAria: 'GitHub에서 NamVu Design에 스타 주기',
  ...
  de: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'NamVu Design Desktop herunterladen',
      downloadTitle: 'Desktop-App herunterladen',
      starAria: 'NamVu Design auf GitHub mit Stern markieren',
  ...
  fr: {
    ...
    header: {
      ...
      download: 'Télécharger',
      downloadAria: 'Télécharger NamVu Design Desktop',
      downloadTitle: "Télécharger l'application desktop",
      starAria: 'Ajouter une étoile à NamVu Design sur GitHub',
  ...
  ru: {
    ...
    header: {
      ...
      download: 'Скачать',
      downloadAria: 'Скачать NamVu Design Desktop',
      downloadTitle: 'Скачать desktop-приложение',
      starAria: 'Поставить звезду NamVu Design на GitHub',
  ...
  es: {
    ...
    header: {
      ...
      download: 'Descargar',
      downloadAria: 'Descargar NamVu Design Desktop',
      downloadTitle: 'Descargar la app de escritorio',
      starAria: 'Dar Star a NamVu Design en GitHub',
  ...
  'pt-br': {
    ...
    header: {
      ...
      download: 'Baixar',
      downloadAria: 'Baixar NamVu Design Desktop',
      downloadTitle: 'Baixar o app desktop',
      starAria: 'Dar Star no NamVu Design no GitHub',
  ...
  it: {
    ...
    header: {
      ...
      download: 'Scarica',
      downloadAria: 'Scarica NamVu Design Desktop',
      downloadTitle: "Scarica l'app desktop",
      starAria: 'Metti una Star a NamVu Design su GitHub',
  ...
  vi: {
    ...
    header: {
      ...
      download: 'Tải xuống',
      downloadAria: 'Tải NamVu Design Desktop',
      downloadTitle: 'Tải ứng dụng desktop',
      starAria: 'Star NamVu Design trên GitHub',
  ...
  pl: {
    ...
    header: {
      ...
      download: 'Pobierz',
      downloadAria: 'Pobierz NamVu Design Desktop',
      downloadTitle: 'Pobierz aplikację desktop',
      starAria: 'Daj gwiazdkę NamVu Design na GitHubie',
  ...
  id: {
    ...
    header: {
      ...
      download: 'Unduh',
      downloadAria: 'Unduh NamVu Design Desktop',
      downloadTitle: 'Unduh aplikasi desktop',
      starAria: 'Beri Star NamVu Design di GitHub',
  ...
  nl: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'NamVu Design Desktop downloaden',
      downloadTitle: 'Desktop-app downloaden',
      starAria: 'Geef NamVu Design een Star op GitHub',
  ...
  ar: {
    ...
    header: {
      ...
      download: 'تنزيل',
      downloadAria: 'تنزيل NamVu Design Desktop',
      downloadTitle: 'تنزيل تطبيق سطح المكتب',
      starAria: 'ضع نجمة لـ NamVu Design على GitHub',
  ...
  tr: {
    ...
    header: {
      ...
      download: 'İndir',
      downloadAria: 'NamVu Design Desktop indir',
      downloadTitle: 'Desktop uygulamasını indir',
      starAria: "GitHub'da NamVu Design'a Star ver",
  ...
  uk: {
    ...
    header: {
      ...
      download: 'Завантажити',
      downloadAria: 'Завантажити NamVu Design Desktop',
      downloadTitle: 'Завантажити desktop-застосунок',
      starAria: 'Поставити зірку NamVu Design на GitHub',
...
const HOME_SEO_COPY: Record<LandingLocaleCode, HomeSeoCopy> = {
  en: {
    title: 'NamVu Design — Best Open Source Claude Design Alternative',
    description:
  ...
  zh: {
    title: 'NamVu Design —— 最佳 Claude Design 开源替代',
    description:
      'NamVu Design 是开源的 vibe design workspace，也是 Claude Design 的开源替代——用你自己的 coding agent 做原型、落地页、数据看板、Slides 和 HTML 视频。',
  },
  'zh-tw': {
    title: 'NamVu Design —— 最佳 Claude Design 開源替代',
    description:
      'NamVu Design 是最佳的開源、本地優先 Claude Design 替代方案。用 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 生成簡報、落地頁、儀表板與品牌系統，背後由 {skills} 個可組合 Skill 與 {systems} 套 DESIGN.md 系統驅動。',
  },
  ja: {
    title: 'NamVu Design — 最高のオープンソース Claude Design 代替',
    description:
      'オープンソースの vibe design workspace であり Claude Design の代替。自分の coding agent でプロトタイプ、ランディングページ、ダッシュボード、スライド、HTML 動画を作成。',
  },
  ko: {
    title: 'NamVu Design — 최고의 오픈소스 Claude Design 대안',
    description:
      '오픈소스 vibe design workspace이자 Claude Design 대안. 내 coding agent로 프로토타입, 랜딩 페이지, 대시보드, 슬라이드, HTML 비디오를 만드세요.',
  },
  de: {
    title: 'NamVu Design — beste Open-Source-Alternative zu Claude Design',
    description:
  ...
  fr: {
    title: "NamVu Design — la meilleure alternative open source à Claude Design",
    description:
  ...
  ru: {
    title: 'NamVu Design — лучшая open-source альтернатива Claude Design',
    description:
  ...
  es: {
    title: 'NamVu Design — la mejor alternativa open source a Claude Design',
    description:
  ...
  'pt-br': {
    title: 'NamVu Design — a melhor alternativa open source ao Claude Design',
    description:
  ...
  it: {
    title: "NamVu Design — la migliore alternativa open source a Claude Design",
    description:
  ...
  vi: {
    title: 'NamVu Design — lựa chọn mã nguồn mở tốt nhất thay Claude Design',
    description:
      'NamVu Design là lựa chọn mã nguồn mở, local-first tốt nhất thay Claude Design. Tạo deck, landing page, dashboard và hệ thống thương hiệu bằng Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen, với {skills} skill có thể ghép và {systems} hệ DESIGN.md di động.',
  },
  pl: {
    title: 'NamVu Design — najlepsza open-source alternatywa dla Claude Design',
    description:
      'NamVu Design to najlepsza, open-source i local-first alternatywa dla Claude Design. Twórz decki, landing page, dashboardy i systemy marki z Claude Code, Codex, Cursor, Gemini, OpenCode lub Qwen, używając {skills} kompozycyjnych skills i {systems} przenośnych systemów DESIGN.md.',
  },
  id: {
    title: 'NamVu Design — alternatif open source terbaik untuk Claude Design',
    description:
      'NamVu Design adalah alternatif terbaik, open source, dan local-first untuk Claude Design. Buat deck, landing page, dashboard, dan sistem merek dengan Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen, didukung {skills} skill komposable dan {systems} sistem DESIGN.md portabel.',
  },
  nl: {
    title: 'NamVu Design — het beste open-source alternatief voor Claude Design',
    description:
      'NamVu Design is het beste open-source en local-first alternatief voor Claude Design. Maak decks, landingspagina’s, dashboards en merksystemen met Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen, aangedreven door {skills} combineerbare skills en {systems} draagbare DESIGN.md-systemen.',
  },
  ar: {
    title: 'NamVu Design — أفضل بديل مفتوح المصدر لـ Claude Design',
    description:
      'NamVu Design هو أفضل بديل مفتوح المصدر والمحلي أولاً لـ Claude Design. أنشئ عروضاً وصفحات هبوط ولوحات بيانات وأنظمة علامة عبر Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen، مع {skills} مهارة قابلة للتركيب و {systems} نظام DESIGN.md قابل للنقل.',
  },
  tr: {
    title: "NamVu Design — Claude Design'ın en iyi açık kaynak alternatifi",
    description:
  ...
  uk: {
    title: 'NamVu Design — найкраща open-source альтернатива Claude Design',
    description:
      'NamVu Design — найкраща open-source і local-first альтернатива Claude Design. Створюйте презентації, лендинги, дашборди та бренд-системи через Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen на базі {skills} skills і {systems} DESIGN.md-систем.',
  },
};
...
const HOME_FAQ_COPY: Record<LandingLocaleCode, HomeFaqTemplate[]> = {
  en: [
    {
      q: 'What is NamVu Design?',
      a: 'NamVu Design is the official open-source AI design workspace from the nexu-io/open-design project. It turns a local coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode, or Qwen — into a design engine driven by composable skills and portable DESIGN.md systems.',
    },
    {
      q: 'Is NamVu Design official?',
      a: 'Yes. The canonical project lives at {origin} and the source is on GitHub at {repo}. "NamVu Design", "OpenDesign", "open-design", and "NamVu Design AI" all refer to this same project.',
      official: true,
    },
    {
      q: 'How is NamVu Design different from Claude Design?',
      a: 'Claude Design is a hosted product tied to a single vendor. NamVu Design is local-first, open source under Apache-2.0, and BYOK: you bring your own agent, credentials, and DESIGN.md system.',
    },
    {
      q: 'Is NamVu Design an open-source Claude Design alternative?',
      a: 'Yes — NamVu Design is the open-source, local-first Claude Design alternative. Where Claude Design is closed, hosted, and locked to Anthropic models, NamVu Design is Apache-2.0, runs on your own machine, and is BYOK, so you drive it with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen and keep every artifact as files you own.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'What is a vibe design workspace?',
      a: 'A vibe design workspace is where you design by describing intent to an AI agent — from prompt to prototype, web page, slides, or HTML video — instead of hand-placing every element. NamVu Design is an open-source, agent-native vibe design workspace: it wires the coding agent you already run into a full design workflow, so one tool takes you from a rough idea to production-ready output you own.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Does NamVu Design run locally?',
    ...
    {
      q: 'Which coding agents does NamVu Design support?',
      a: 'NamVu Design ships 17 first-party BYOK adapters out of the box: Claude Code, Codex, Cursor, Gemini CLI, GitHub Copilot CLI, Grok, Hermes, Kimi, Devin for Terminal, OpenCode, Qwen, DeepSeek, Pi, Mistral Vibe, Kiro, Kilo, and Qoder. Any adapter that speaks the same skill protocol works — switching agents is a config change, not a redesign.',
    },
    {
    ...
    // evaluator concerns), then workflow / roadmap. ----
    {
      ...
      a: 'Only your prompt and skill context goes to whichever provider you bring keys for (BYOK). NamVu Design has no server of its own — the daemon talks to your provider directly. Generated artifacts land as files in your project directory, not in any vendor cloud.',
    },
    {
      q: 'Can I run NamVu Design without installing the CLI or desktop app?',
      a: 'Not today. NamVu Design is local-first by design — the minimum is a local daemon plus an agent (Claude Code, Codex, Cursor, Gemini CLI, or one of the 17 supported adapters). A hosted sandbox is on the roadmap but not the priority: artifacts in your repo beat documents in someone else\'s database.',
    },
    {
      q: 'How much does NamVu Design cost?',
      a: 'The product is free and Apache-2.0 — there is no NamVu Design subscription. You pay the API costs of whichever provider you use (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), billed directly to your account. BYOK keeps both the credentials and the spend on your side of the line.',
    },
    {
      q: 'Can I self-host NamVu Design on Vercel, Cloudflare, or my own server?',
    ...
    {
      q: 'How do I move my brand into NamVu Design?',
    ...
    {
      q: 'What\'s on the NamVu Design roadmap?',
  ...
  zh: [
    {
      q: 'NamVu Design 是开源的 Claude Design 替代品吗？',
      a: '是的——NamVu Design 是开源、本地优先的 Claude Design 替代方案。Claude Design 闭源、托管、锁定 Anthropic 模型；NamVu Design 是 Apache-2.0，跑在你自己的机器上，且 BYOK，你可以用 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 驱动它，产出的每个文件都归你所有。',
      href: '/alternatives/claude-design/',
    },
    {
      q: '什么是 vibe design workspace？',
      a: 'vibe design workspace 是通过向 AI agent 描述意图来做设计——从 prompt 到原型、网页、slides、HTML 视频——而不是手动摆放每个元素。NamVu Design 是一个开源、agent-native 的 vibe design workspace：把你已经在用的 coding agent 接进完整设计工作流，一个工具就把你从粗略想法带到可交付、归你所有的成品。',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'NamVu Design 是什么？',
      a: 'NamVu Design 是 nexu-io/open-design 项目的官方开源 AI 设计工作台。它把本地编码 Agent（Claude Code、Codex、Cursor、Gemini CLI、OpenCode 或 Qwen）变成设计引擎，并由可组合 SKILL.md 工作流驱动。',
    },
    {
      q: 'NamVu Design 是官方项目吗？',
      a: '是。官方站点是 {origin}，源代码在 GitHub：{repo}。"NamVu Design"、"OpenDesign"、"open-design" 和 "NamVu Design AI" 都指向同一个项目。',
      official: true,
    },
    {
      q: '它和 Claude Design 有什么不同？',
      a: 'Claude Design 是绑定单一厂商的云端产品。NamVu Design 本地优先、Apache-2.0 开源，并且 BYOK：你使用自己的 Agent、密钥和 Skill 规则。',
    },
    {
      q: 'NamVu Design 可以本地运行吗？',
    ...
    },
    {
      ...
      a: '只有你的 prompt 和 Skill 上下文会发给你自带密钥（BYOK）的那家模型供应商。NamVu Design 没有自己的服务器——daemon 直接与你的供应商通信，生成的 artifact 以文件形式落在你的项目目录里，不会进入任何厂商云端。',
    },
    {
      q: '不安装 CLI 或桌面端能用 NamVu Design 吗？',
      a: '目前不行。NamVu Design 的设计就是本地优先——最少需要一个本地 daemon 加一个 Agent（Claude Code、Codex、Cursor、Gemini CLI 或 17 个受支持适配器之一）。托管沙盒在路线图上但不是优先级：落在你仓库里的 artifact，胜过存在别人数据库里的文档。',
    },
    {
      q: 'NamVu Design 要多少钱？',
      a: '产品本身免费且为 Apache-2.0 开源——不存在 NamVu Design 订阅。你只需支付所用供应商（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot 等）的 API 费用，直接计入你自己的账户。BYOK 让密钥和开销都留在你这一侧。',
    },
    {
      q: '可以把 NamVu Design 自托管到 Vercel、Cloudflare 或自己的服务器吗？',
  ...
  'zh-tw': [
    {
      q: 'NamVu Design 是什麼？',
      a: 'NamVu Design 是 nexu-io/open-design 專案的官方開源 AI 設計工作台。它把本地 coding agent（Claude Code、Codex、Cursor、Gemini CLI、OpenCode 或 Qwen）變成設計引擎，並由可組合 Skill 與可攜式 DESIGN.md 系統驅動。',
    },
    {
      q: 'NamVu Design 是官方專案嗎？',
      a: '是。官方站點是 {origin}，原始碼在 GitHub：{repo}。"NamVu Design"、"OpenDesign"、"open-design" 與 "NamVu Design AI" 都指同一個專案。',
      official: true,
    },
    {
      q: '它和 Claude Design 有什麼不同？',
      a: 'Claude Design 是綁定單一供應商的雲端產品。NamVu Design 本地優先、Apache-2.0 開源，並且 BYOK：你使用自己的 agent、密鑰與 DESIGN.md 設計系統。',
    },
    {
      q: 'NamVu Design 可以本地執行嗎？',
    ...
    },
    {
      ...
      a: '只有你的 prompt 與 Skill 上下文會送到你自帶密鑰（BYOK）的那家模型供應商。NamVu Design 沒有自己的伺服器——daemon 直接與你的供應商通訊，生成的 artifact 以檔案形式落在你的專案目錄，不會進入任何廠商雲端。',
    },
    {
      q: '不安裝 CLI 或桌面端能用 NamVu Design 嗎？',
      a: '目前不行。NamVu Design 的設計就是本地優先——最少需要一個本地 daemon 加一個 agent（Claude Code、Codex、Cursor、Gemini CLI 或 17 個受支援 adapter 之一）。託管沙盒在路線圖上但不是優先事項：落在你 repo 裡的 artifact，勝過存在別人資料庫裡的文件。',
    },
    {
      q: 'NamVu Design 要多少錢？',
      a: '產品本身免費且採 Apache-2.0——不存在 NamVu Design 訂閱。你只需支付所用供應商（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot 等）的 API 費用，直接計入你自己的帳戶。BYOK 讓密鑰與開銷都留在你這一側。',
    },
    {
      q: '可以把 NamVu Design 自架到 Vercel、Cloudflare 或自己的伺服器嗎？',
  ...
  ja: [
    {
      q: 'NamVu Design はオープンソースの Claude Design 代替ですか？',
      a: 'はい——NamVu Design はオープンソースかつローカル優先の Claude Design 代替です。Claude Design はクローズドでホスト型、Anthropic モデルに固定されていますが、NamVu Design は Apache-2.0 で自分のマシン上で動き、BYOK。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen で駆動でき、生成物はすべて自分のファイルとして手元に残ります。',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'vibe design workspace とは？',
      a: 'vibe design workspace とは、要素を一つずつ手で配置する代わりに、AI エージェントに意図を伝えて設計する場です——prompt からプロトタイプ、Web ページ、スライド、HTML 動画まで。NamVu Design はオープンソースで agent-native な vibe design workspace で、すでに使っているコーディングエージェントを完全な設計ワークフローに組み込み、ひとつのツールでラフなアイデアから自分のものになる完成物まで導きます。',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'NamVu Design とは何ですか？',
      a: 'NamVu Design は nexu-io/open-design プロジェクト公式のオープンソース AI デザインワークスペースです。Claude Code、Codex、Cursor、Gemini CLI、OpenCode、Qwen などのローカル coding agent を、スキルと DESIGN.md システムで動くデザインエンジンにします。',
    },
    {
      q: 'NamVu Design は公式ですか？',
      a: 'はい。公式サイトは {origin}、ソースコードは GitHub の {repo} です。"NamVu Design"、"OpenDesign"、"open-design"、"NamVu Design AI" は同じプロジェクトを指します。',
      official: true,
    },
    {
      q: 'Claude Design と何が違いますか？',
      a: 'Claude Design は単一ベンダーに紐づくホスト型製品です。NamVu Design はローカル優先、Apache-2.0 のオープンソース、BYOK で、自分の agent、鍵、DESIGN.md を使います。',
    },
    {
      q: 'ローカルで動きますか？',
    ...
    },
    {
      ...
      a: '送られるのは、あなたが鍵を持ち込んだ（BYOK）プロバイダーへの prompt とスキルのコンテキストだけです。NamVu Design 自身のサーバーはなく、daemon があなたのプロバイダーと直接通信します。生成物はベンダーのクラウドではなく、プロジェクトディレクトリにファイルとして保存されます。',
    },
    {
      q: 'CLI やデスクトップアプリなしで使えますか？',
      a: '現時点では使えません。NamVu Design は設計からローカル優先で、最低限ローカル daemon と agent（Claude Code、Codex、Cursor、Gemini CLI、または対応する 17 の adapter のいずれか）が必要です。ホスト型サンドボックスはロードマップにありますが優先事項ではありません。自分の repo にある artifact は、他人のデータベースにあるドキュメントに勝ります。',
    },
    {
      q: 'NamVu Design の料金は？',
      a: 'プロダクト自体は無料で Apache-2.0 です。NamVu Design のサブスクリプションはありません。支払うのは利用するプロバイダー（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot など）の API 料金だけで、あなたのアカウントに直接請求されます。BYOK により、鍵も支出もあなたの側に残ります。',
    },
    {
    ...
    {
      q: '自分のブランドを NamVu Design に持ち込むには？',
  ...
  ko: [
    {
      q: 'NamVu Design은 오픈소스 Claude Design 대안인가요?',
      a: '네——NamVu Design은 오픈소스, 로컬 우선 Claude Design 대안입니다. Claude Design은 폐쇄형·호스팅형이며 Anthropic 모델에 묶여 있지만, NamVu Design은 Apache-2.0이고 내 컴퓨터에서 실행되며 BYOK입니다. Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen으로 구동할 수 있고 생성된 모든 산출물은 내 파일로 남습니다.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'vibe design workspace란 무엇인가요?',
      a: 'vibe design workspace는 모든 요소를 손으로 배치하는 대신 AI 에이전트에 의도를 설명해 디자인하는 공간입니다 — prompt에서 프로토타입, 웹 페이지, 슬라이드, HTML 비디오까지. NamVu Design은 오픈소스이자 agent-native한 vibe design workspace로, 이미 쓰는 코딩 에이전트를 완전한 디자인 워크플로에 연결해 하나의 도구로 거친 아이디어에서 내 것이 되는 완성물까지 이끕니다.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'NamVu Design은 무엇인가요?',
      a: 'NamVu Design은 nexu-io/open-design 프로젝트의 공식 오픈소스 AI 디자인 워크스페이스입니다. Claude Code, Codex, Cursor, Gemini CLI, OpenCode, Qwen 같은 로컬 coding agent를 조합형 skill과 DESIGN.md 시스템으로 구동되는 디자인 엔진으로 바꿉니다.',
    },
    {
      q: 'NamVu Design은 공식 프로젝트인가요?',
      a: '네. 공식 사이트는 {origin}이고 소스는 GitHub의 {repo}에 있습니다. "NamVu Design", "OpenDesign", "open-design", "NamVu Design AI"는 같은 프로젝트를 가리킵니다.',
      official: true,
    },
    {
      q: 'Claude Design과 무엇이 다른가요?',
      a: 'Claude Design은 단일 벤더에 묶인 호스팅 제품입니다. NamVu Design은 로컬 우선, Apache-2.0 오픈소스, BYOK이며 사용자의 agent, 키, DESIGN.md 시스템을 그대로 씁니다.',
    },
    {
      q: '로컬에서 실행되나요?',
    ...
    },
    {
      ...
      a: '키를 직접 가져온(BYOK) 프로바이더에게 prompt와 skill 컨텍스트만 전송됩니다. NamVu Design은 자체 서버가 없으며 daemon이 프로바이더와 직접 통신합니다. 생성된 artifact는 벤더 클라우드가 아니라 프로젝트 디렉터리에 파일로 저장됩니다.',
    },
    {
      q: 'CLI나 데스크톱 앱 없이 쓸 수 있나요?',
      a: '아직은 안 됩니다. NamVu Design은 설계부터 로컬 우선이라 최소한 로컬 daemon과 agent(Claude Code, Codex, Cursor, Gemini CLI 또는 지원되는 17개 adapter 중 하나)가 필요합니다. 호스팅 샌드박스는 로드맵에 있지만 우선순위는 아닙니다. 내 repo에 남는 artifact가 남의 데이터베이스에 있는 문서보다 낫기 때문입니다.',
    },
    {
      q: 'NamVu Design 비용은 얼마인가요?',
      a: '제품은 무료이고 Apache-2.0입니다. NamVu Design 구독은 없습니다. 사용하는 프로바이더(Anthropic, OpenAI, Google, Mistral, xAI, Moonshot 등)의 API 비용만 본인 계정으로 직접 결제하면 됩니다. BYOK 덕분에 키와 지출 모두 사용자 쪽에 남습니다.',
    },
    {
  ...
  de: [
    {
      q: 'Ist NamVu Design eine quelloffene Claude-Design-Alternative?',
      a: 'Ja — NamVu Design ist die quelloffene, lokale Claude-Design-Alternative. Wo Claude Design geschlossen, gehostet und an Anthropic-Modelle gebunden ist, ist NamVu Design Apache-2.0, läuft auf deinem eigenen Rechner und ist BYOK: Du steuerst es mit Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen und behältst jedes Ergebnis als eigene Dateien.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Was ist ein Vibe Design Workspace?',
      a: 'Ein Vibe Design Workspace ist ein Ort, an dem du gestaltest, indem du einem KI-Agent deine Absicht beschreibst — vom Prompt zu Prototyp, Webseite, Slides oder HTML-Video — statt jedes Element von Hand zu platzieren. NamVu Design ist ein quelloffener, agent-nativer Vibe Design Workspace: Er bindet den Coding-Agent, den du bereits nutzt, in einen vollständigen Design-Workflow ein, sodass ein Werkzeug dich von der groben Idee zum fertigen, dir gehörenden Ergebnis bringt.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Was ist NamVu Design?',
      a: 'NamVu Design ist der offizielle Open-Source-AI-Design-Workspace des Projekts nexu-io/open-design. Es macht lokale Coding-Agents wie Claude Code, Codex, Cursor, Gemini CLI, OpenCode oder Qwen zu einer Design-Engine auf Basis von Skills und DESIGN.md-Systemen.',
    },
    {
      q: 'Ist NamVu Design offiziell?',
      a: 'Ja. Die kanonische Website ist {origin}, der Quellcode liegt auf GitHub unter {repo}. "NamVu Design", "OpenDesign", "open-design" und "NamVu Design AI" meinen dasselbe Projekt.',
      official: true,
    },
    {
      q: 'Worin unterscheidet es sich von Claude Design?',
      a: 'Claude Design ist ein gehostetes Produkt eines einzelnen Anbieters. NamVu Design ist local-first, Apache-2.0 Open Source und BYOK: Sie bringen Agent, Schlüssel und DESIGN.md-System selbst mit.',
    },
    {
      q: 'Läuft NamVu Design lokal?',
    ...
    },
    {
      ...
      a: 'Nur Ihr Prompt und der Skill-Kontext gehen an den Provider, für den Sie eigene Schlüssel mitbringen (BYOK). NamVu Design hat keinen eigenen Server — der Daemon spricht direkt mit Ihrem Provider. Generierte Artifacts landen als Dateien in Ihrem Projektverzeichnis, nicht in einer Vendor-Cloud.',
    },
    {
      q: 'Kann ich NamVu Design ohne CLI oder Desktop-App nutzen?',
      a: 'Heute nicht. NamVu Design ist bewusst local-first — das Minimum ist ein lokaler Daemon plus ein Agent (Claude Code, Codex, Cursor, Gemini CLI oder einer der 17 unterstützten Adapter). Eine gehostete Sandbox steht auf der Roadmap, hat aber keine Priorität: Artifacts in Ihrem Repo schlagen Dokumente in fremden Datenbanken.',
    },
    {
      q: 'Was kostet NamVu Design?',
    ...
    {
      q: 'Kann ich NamVu Design auf Vercel, Cloudflare oder eigenen Servern hosten?',
    ...
    {
      q: 'Wie bringe ich meine Marke in NamVu Design?',
  ...
  fr: [
    {
      q: 'NamVu Design est-il une alternative open source à Claude Design ?',
      a: 'Oui — NamVu Design est l’alternative open source et locale à Claude Design. Là où Claude Design est fermé, hébergé et verrouillé aux modèles Anthropic, NamVu Design est en Apache-2.0, s’exécute sur votre propre machine et fonctionne en BYOK : pilotez-le avec Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen et gardez chaque livrable sous forme de fichiers qui vous appartiennent.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Qu’est-ce qu’un vibe design workspace ?',
      a: 'Un vibe design workspace est un espace où l’on conçoit en décrivant son intention à un agent IA — du prompt au prototype, page web, slides ou vidéo HTML — plutôt qu’en plaçant chaque élément à la main. NamVu Design est un vibe design workspace open source et agent-native : il intègre l’agent de code que vous utilisez déjà dans un flux de design complet, pour passer d’une idée brute à un résultat livrable et bien à vous.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: "Qu'est-ce qu'NamVu Design ?",
      a: "NamVu Design est l'espace de travail officiel et open source du projet nexu-io/open-design. Il transforme un agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode ou Qwen — en moteur de design piloté par des skills composables et des systèmes DESIGN.md portables.",
    },
    {
      q: 'NamVu Design est-il officiel ?',
      a: 'Oui. Le site canonique est {origin} et le code source est sur GitHub à {repo}. "NamVu Design", "OpenDesign", "open-design" et "NamVu Design AI" désignent le même projet.',
      official: true,
    },
    {
      q: 'Quelle différence avec Claude Design ?',
      a: 'Claude Design est un produit hébergé lié à un fournisseur unique. NamVu Design est local-first, open source Apache-2.0 et BYOK : vous apportez votre agent, vos clés et votre système DESIGN.md.',
    },
    {
      q: 'NamVu Design fonctionne-t-il en local ?',
    ...
    },
    {
      ...
      a: 'Seuls votre prompt et le contexte des skills partent vers le fournisseur dont vous apportez les clés (BYOK). NamVu Design n\'a aucun serveur propre — le daemon parle directement à votre fournisseur. Les artifacts générés sont des fichiers dans votre répertoire de projet, pas dans le cloud d\'un vendeur.',
    },
    {
      q: 'Puis-je utiliser NamVu Design sans installer la CLI ou l\'app desktop ?',
      a: 'Pas aujourd\'hui. NamVu Design est local-first par conception — le minimum est un daemon local plus un agent (Claude Code, Codex, Cursor, Gemini CLI ou l\'un des 17 adaptateurs supportés). Une sandbox hébergée est sur la roadmap mais n\'est pas la priorité : des artifacts dans votre repo valent mieux que des documents dans la base de données de quelqu\'un d\'autre.',
    },
    {
      q: 'Combien coûte NamVu Design ?',
      a: 'Le produit est gratuit et sous Apache-2.0 — il n\'existe pas d\'abonnement NamVu Design. Vous payez les coûts d\'API du fournisseur que vous utilisez (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), facturés directement sur votre compte. Le BYOK garde les clés et la dépense de votre côté.',
    },
    {
      q: 'Puis-je auto-héberger NamVu Design sur Vercel, Cloudflare ou mon propre serveur ?',
    ...
    {
      q: 'Comment importer ma marque dans NamVu Design ?',
    ...
    {
      q: 'Qu\'y a-t-il sur la roadmap d\'NamVu Design ?',
  ...
  ru: [
    {
      q: 'NamVu Design — это open-source альтернатива Claude Design?',
      a: 'Да — NamVu Design это открытая, локальная альтернатива Claude Design. Claude Design закрыт, работает в облаке и привязан к моделям Anthropic, а NamVu Design — Apache-2.0, запускается на вашей машине и работает по BYOK: управляйте им через Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen и храните каждый результат как свои файлы.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Что такое vibe design workspace?',
      a: 'Vibe design workspace — это среда, где вы проектируете, описывая замысел ИИ-агенту — от промпта до прототипа, веб-страницы, слайдов или HTML-видео — вместо расстановки каждого элемента вручную. NamVu Design это открытый, agent-native vibe design workspace: он встраивает кодинг-агента, которым вы уже пользуетесь, в полный дизайн-процесс, и один инструмент ведёт вас от черновой идеи к готовому результату, который принадлежит вам.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Что такое NamVu Design?',
      a: 'NamVu Design — официальный open-source AI design workspace проекта nexu-io/open-design. Он превращает локальный coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode или Qwen — в design-движок на базе composable skills и переносимых DESIGN.md-систем.',
    },
    {
      q: 'NamVu Design официальный?',
      a: 'Да. Канонический сайт — {origin}, исходный код — на GitHub: {repo}. "NamVu Design", "OpenDesign", "open-design" и "NamVu Design AI" обозначают один проект.',
      official: true,
    },
    {
      q: 'Чем он отличается от Claude Design?',
      a: 'Claude Design — hosted-продукт одного вендора. NamVu Design — local-first, Apache-2.0 open source и BYOK: вы используете своего agent, свои ключи и свою DESIGN.md-систему.',
    },
    {
      q: 'NamVu Design запускается локально?',
    ...
    },
    {
      ...
      a: 'Провайдеру, чьи ключи вы принесли (BYOK), уходят только ваш prompt и контекст skills. У NamVu Design нет собственного сервера — daemon общается с вашим провайдером напрямую. Generated artifacts сохраняются файлами в папке проекта, а не в облаке вендора.',
    },
    {
      q: 'Можно использовать NamVu Design без установки CLI или desktop-приложения?',
      a: 'Пока нет. NamVu Design по замыслу local-first — минимум это локальный daemon плюс agent (Claude Code, Codex, Cursor, Gemini CLI или один из 17 поддерживаемых adapters). Hosted-песочница есть в роадмапе, но не в приоритете: artifacts в вашем репозитории лучше документов в чужой базе данных.',
    },
    {
      q: 'Сколько стоит NamVu Design?',
      a: 'Продукт бесплатный и под Apache-2.0 — подписки NamVu Design не существует. Вы платите только за API того провайдера, которым пользуетесь (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot и др.), напрямую со своего аккаунта. BYOK оставляет и ключи, и расходы на вашей стороне.',
    },
    {
      q: 'Можно self-host NamVu Design на Vercel, Cloudflare или своём сервере?',
    ...
    {
      q: 'Как перенести свой бренд в NamVu Design?',
  ...
  es: [
    {
      q: '¿NamVu Design es una alternativa open source a Claude Design?',
      a: 'Sí — NamVu Design es la alternativa open source y local a Claude Design. Donde Claude Design es cerrado, alojado y atado a los modelos de Anthropic, NamVu Design es Apache-2.0, se ejecuta en tu propia máquina y es BYOK: contrólalo con Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen y conserva cada resultado como archivos que son tuyos.',
      href: '/alternatives/claude-design/',
    },
    {
      q: '¿Qué es un vibe design workspace?',
      a: 'Un vibe design workspace es un espacio donde diseñas describiendo tu intención a un agente de IA — del prompt al prototipo, página web, slides o vídeo HTML — en lugar de colocar cada elemento a mano. NamVu Design es un vibe design workspace open source y agent-native: conecta el agente de código que ya usas a un flujo de diseño completo, de modo que una sola herramienta te lleva de una idea en bruto a un resultado listo y tuyo.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: '¿Qué es NamVu Design?',
      a: 'NamVu Design es el workspace oficial y open source de IA de diseño del proyecto nexu-io/open-design. Convierte un coding agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode o Qwen — en un motor de diseño con skills componibles y sistemas DESIGN.md portables.',
    },
    {
      q: '¿NamVu Design es oficial?',
      a: 'Sí. El sitio canónico es {origin} y el código fuente está en GitHub en {repo}. "NamVu Design", "OpenDesign", "open-design" y "NamVu Design AI" apuntan al mismo proyecto.',
      official: true,
    },
    {
      q: '¿En qué se diferencia de Claude Design?',
      a: 'Claude Design es un producto alojado ligado a un solo proveedor. NamVu Design es local-first, open source Apache-2.0 y BYOK: usas tu propio agent, claves y sistema DESIGN.md.',
    },
    {
      q: '¿NamVu Design corre localmente?',
    ...
    },
    {
      ...
      a: 'Solo tu prompt y el contexto de skills van al proveedor cuyas claves aportas (BYOK). NamVu Design no tiene servidor propio: el daemon habla directamente con tu proveedor. Los artifacts generados quedan como archivos en tu directorio de proyecto, no en la nube de ningún vendor.',
    },
    {
      q: '¿Puedo usar NamVu Design sin instalar la CLI ni la app de escritorio?',
      a: 'Hoy no. NamVu Design es local-first por diseño: el mínimo es un daemon local más un agent (Claude Code, Codex, Cursor, Gemini CLI o uno de los 17 adaptadores soportados). Un sandbox alojado está en el roadmap pero no es la prioridad: los artifacts en tu repo valen más que documentos en la base de datos de otro.',
    },
    {
      q: '¿Cuánto cuesta NamVu Design?',
      a: 'El producto es gratuito y Apache-2.0: no existe una suscripción de NamVu Design. Pagas los costes de API del proveedor que uses (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), facturados directamente a tu cuenta. BYOK mantiene las claves y el gasto de tu lado.',
    },
    {
      q: '¿Puedo autoalojar NamVu Design en Vercel, Cloudflare o mi propio servidor?',
    ...
    {
      q: '¿Cómo llevo mi marca a NamVu Design?',
    ...
    {
      q: '¿Qué hay en el roadmap de NamVu Design?',
  ...
  'pt-br': [
    {
      q: 'O NamVu Design é uma alternativa open source ao Claude Design?',
      a: 'Sim — o NamVu Design é a alternativa open source e local ao Claude Design. Enquanto o Claude Design é fechado, hospedado e preso aos modelos da Anthropic, o NamVu Design é Apache-2.0, roda na sua própria máquina e é BYOK: use Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen para conduzi-lo e mantenha cada entrega como arquivos que são seus.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'O que é um vibe design workspace?',
      a: 'Um vibe design workspace é onde você projeta descrevendo a intenção a um agente de IA — do prompt ao protótipo, página web, slides ou vídeo HTML — em vez de posicionar cada elemento à mão. O NamVu Design é um vibe design workspace open source e agent-native: integra o coding agent que você já usa a um fluxo de design completo, então uma ferramenta leva você de uma ideia bruta a um resultado pronto e seu.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'O que é NamVu Design?',
      a: 'NamVu Design é o workspace oficial, open source, de design com IA do projeto nexu-io/open-design. Ele transforma um coding agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode ou Qwen — em um motor de design movido por skills componíveis e sistemas DESIGN.md portáteis.',
    },
    {
      q: 'NamVu Design é oficial?',
      a: 'Sim. O site canônico é {origin} e o código-fonte está no GitHub em {repo}. "NamVu Design", "OpenDesign", "open-design" e "NamVu Design AI" apontam para o mesmo projeto.',
      official: true,
    },
    {
      q: 'Qual a diferença para o Claude Design?',
      a: 'Claude Design é um produto hospedado preso a um fornecedor. NamVu Design é local-first, open source Apache-2.0 e BYOK: você traz seu agent, suas chaves e seu sistema DESIGN.md.',
    },
    {
      q: 'NamVu Design roda localmente?',
    ...
    },
    {
      ...
      a: 'Só o seu prompt e o contexto de skills vão para o provedor cujas chaves você traz (BYOK). O NamVu Design não tem servidor próprio — o daemon fala diretamente com o seu provedor. Os artifacts gerados ficam como arquivos no diretório do projeto, não na nuvem de nenhum vendor.',
    },
    {
      q: 'Posso usar o NamVu Design sem instalar a CLI ou o app desktop?',
      a: 'Hoje não. O NamVu Design é local-first por design — o mínimo é um daemon local mais um agent (Claude Code, Codex, Cursor, Gemini CLI ou um dos 17 adaptadores suportados). Um sandbox hospedado está no roadmap, mas não é prioridade: artifacts no seu repo valem mais que documentos no banco de dados de outra pessoa.',
    },
    {
      q: 'Quanto custa o NamVu Design?',
      a: 'O produto é gratuito e Apache-2.0 — não existe assinatura do NamVu Design. Você paga os custos de API do provedor que usar (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot etc.), cobrados direto na sua conta. O BYOK mantém as chaves e o gasto do seu lado.',
    },
    {
      q: 'Posso auto-hospedar o NamVu Design na Vercel, Cloudflare ou no meu servidor?',
    ...
    {
      q: 'Como levo minha marca para o NamVu Design?',
    ...
    {
      q: 'O que tem no roadmap do NamVu Design?',
  ...
  it: [
    {
      q: 'NamVu Design è un’alternativa open source a Claude Design?',
      a: 'Sì — NamVu Design è l’alternativa open source e locale a Claude Design. Dove Claude Design è chiuso, ospitato e legato ai modelli Anthropic, NamVu Design è Apache-2.0, gira sulla tua macchina ed è BYOK: guidalo con Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen e conserva ogni risultato come file tuoi.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Che cos’è un vibe design workspace?',
      a: 'Un vibe design workspace è uno spazio in cui progetti descrivendo l’intento a un agente IA — dal prompt al prototipo, pagina web, slide o video HTML — invece di posizionare ogni elemento a mano. NamVu Design è un vibe design workspace open source e agent-native: collega il coding agent che già usi a un flusso di design completo, così un solo strumento ti porta da un’idea grezza a un risultato pronto e tuo.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: "Cos'è NamVu Design?",
      a: 'NamVu Design è il workspace ufficiale e open source di AI design del progetto nexu-io/open-design. Trasforma un coding agent locale — Claude Code, Codex, Cursor, Gemini CLI, OpenCode o Qwen — in un motore di design guidato da skill componibili e sistemi DESIGN.md portabili.',
    },
    {
      q: 'NamVu Design è ufficiale?',
      a: 'Sì. Il sito canonico è {origin} e il codice sorgente è su GitHub in {repo}. "NamVu Design", "OpenDesign", "open-design" e "NamVu Design AI" indicano lo stesso progetto.',
      official: true,
    },
    {
      q: 'In cosa differisce da Claude Design?',
      a: 'Claude Design è un prodotto hosted legato a un solo vendor. NamVu Design è local-first, open source Apache-2.0 e BYOK: usi il tuo agent, le tue chiavi e il tuo sistema DESIGN.md.',
    },
    {
      q: 'NamVu Design gira in locale?',
    ...
    },
    {
      ...
      a: 'Al provider di cui porti le chiavi (BYOK) arrivano solo il tuo prompt e il contesto delle skill. NamVu Design non ha server propri — il daemon parla direttamente con il tuo provider. Gli artifact generati restano come file nella directory del progetto, non nel cloud di un vendor.',
    },
    {
      q: 'Posso usare NamVu Design senza installare la CLI o l\'app desktop?',
      a: 'Oggi no. NamVu Design è local-first per progettazione — il minimo è un daemon locale più un agent (Claude Code, Codex, Cursor, Gemini CLI o uno dei 17 adapter supportati). Una sandbox hosted è nella roadmap ma non è la priorità: gli artifact nel tuo repo battono i documenti nel database di qualcun altro.',
    },
    {
      q: 'Quanto costa NamVu Design?',
      a: 'Il prodotto è gratuito e Apache-2.0 — non esiste un abbonamento NamVu Design. Paghi solo i costi API del provider che usi (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, ecc.), addebitati direttamente sul tuo account. Il BYOK tiene chiavi e spesa dalla tua parte.',
    },
    {
      q: 'Posso self-hostare NamVu Design su Vercel, Cloudflare o un mio server?',
    ...
    {
      q: 'Come porto il mio brand in NamVu Design?',
    ...
    {
      q: 'Cosa c\'è nella roadmap di NamVu Design?',
  ...
  vi: [
    {
      q: 'NamVu Design là gì?',
      a: 'NamVu Design là workspace thiết kế AI mã nguồn mở chính thức của dự án nexu-io/open-design. Nó biến coding agent chạy trên máy bạn — Claude Code, Codex, Cursor, Gemini CLI, OpenCode hoặc Qwen — thành engine thiết kế dựa trên skill ghép được và hệ DESIGN.md di động.',
    },
    {
      q: 'NamVu Design có phải dự án chính thức không?',
      a: 'Có. Trang canonical là {origin}, mã nguồn ở GitHub: {repo}. "NamVu Design", "OpenDesign", "open-design" và "NamVu Design AI" đều chỉ cùng một dự án.',
      official: true,
    },
    {
      q: 'Khác gì Claude Design?',
      a: 'Claude Design là sản phẩm hosted gắn với một nhà cung cấp. NamVu Design local-first, open source Apache-2.0 và BYOK: bạn dùng agent, key và hệ DESIGN.md của chính mình.',
    },
    {
      q: 'NamVu Design chạy local được không?',
    ...
    },
    {
      ...
      a: 'Chỉ prompt và ngữ cảnh skill của bạn được gửi tới nhà cung cấp mà bạn mang key tới (BYOK). NamVu Design không có máy chủ riêng — daemon nói chuyện trực tiếp với nhà cung cấp của bạn. Artifact tạo ra nằm dưới dạng file trong thư mục dự án, không vào đám mây của vendor nào.',
    },
    {
      q: 'Có thể dùng NamVu Design mà không cài CLI hay app desktop không?',
      a: 'Hiện chưa. NamVu Design được thiết kế local-first — tối thiểu cần một daemon cục bộ cộng một agent (Claude Code, Codex, Cursor, Gemini CLI hoặc một trong 17 adapter được hỗ trợ). Sandbox hosted có trong roadmap nhưng không phải ưu tiên: artifact trong repo của bạn tốt hơn tài liệu trong cơ sở dữ liệu của người khác.',
    },
    {
      q: 'NamVu Design giá bao nhiêu?',
      a: 'Sản phẩm miễn phí và theo Apache-2.0 — không có gói thuê bao NamVu Design. Bạn chỉ trả chi phí API của nhà cung cấp mình dùng (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, v.v.), tính thẳng vào tài khoản của bạn. BYOK giữ cả key lẫn chi tiêu ở phía bạn.',
    },
    {
      q: 'Có thể self-host NamVu Design trên Vercel, Cloudflare hay server riêng không?',
    ...
    {
      q: 'Làm sao đưa thương hiệu của tôi vào NamVu Design?',
    ...
    {
      q: 'Roadmap của NamVu Design có gì?',
  ...
  pl: [
    {
      q: 'Czym jest NamVu Design?',
      a: 'NamVu Design to oficjalny, open-source workspace AI design projektu nexu-io/open-design. Zamienia lokalnego coding agenta — Claude Code, Codex, Cursor, Gemini CLI, OpenCode albo Qwen — w silnik designu oparty o kompozycyjne skills i przenośne systemy DESIGN.md.',
    },
    {
      q: 'Czy NamVu Design jest oficjalne?',
      a: 'Tak. Kanoniczna strona to {origin}, a kod źródłowy jest na GitHubie: {repo}. "NamVu Design", "OpenDesign", "open-design" i "NamVu Design AI" oznaczają ten sam projekt.',
      official: true,
    },
    {
      q: 'Czym różni się od Claude Design?',
      a: 'Claude Design to hostowany produkt jednego dostawcy. NamVu Design jest local-first, open source Apache-2.0 i BYOK: używasz własnego agenta, kluczy i systemu DESIGN.md.',
    },
    {
      q: 'Czy NamVu Design działa lokalnie?',
    ...
    },
    {
      ...
      a: 'Do dostawcy, którego klucze przynosisz (BYOK), trafia tylko Twój prompt i kontekst skills. NamVu Design nie ma własnego serwera — daemon rozmawia z Twoim dostawcą bezpośrednio. Wygenerowane artifacts lądują jako pliki w katalogu projektu, a nie w chmurze żadnego vendora.',
    },
    {
      q: 'Czy mogę używać NamVu Design bez instalowania CLI ani aplikacji desktop?',
      a: 'Dziś nie. NamVu Design jest local-first z założenia — minimum to lokalny daemon plus agent (Claude Code, Codex, Cursor, Gemini CLI albo jeden z 17 wspieranych adapterów). Hostowany sandbox jest w roadmapie, ale nie jest priorytetem: artifacts w Twoim repo są lepsze niż dokumenty w cudzej bazie danych.',
    },
    {
      q: 'Ile kosztuje NamVu Design?',
      a: 'Produkt jest darmowy i na licencji Apache-2.0 — nie istnieje subskrypcja NamVu Design. Płacisz tylko koszty API dostawcy, którego używasz (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot itd.), rozliczane bezpośrednio na Twoim koncie. BYOK trzyma i klucze, i wydatki po Twojej stronie.',
    },
    {
      q: 'Czy mogę self-hostować NamVu Design na Vercel, Cloudflare albo własnym serwerze?',
    ...
    {
      q: 'Jak przenieść moją markę do NamVu Design?',
    ...
    {
      q: 'Co jest w roadmapie NamVu Design?',
  ...
  id: [
    {
      q: 'Apa itu NamVu Design?',
      a: 'NamVu Design adalah workspace AI design resmi dan open source dari proyek nexu-io/open-design. Ia mengubah coding agent lokal — Claude Code, Codex, Cursor, Gemini CLI, OpenCode, atau Qwen — menjadi mesin desain berbasis skill komposable dan sistem DESIGN.md portabel.',
    },
    {
      q: 'Apakah NamVu Design resmi?',
      a: 'Ya. Situs canonical ada di {origin} dan source code ada di GitHub: {repo}. "NamVu Design", "OpenDesign", "open-design", dan "NamVu Design AI" merujuk ke proyek yang sama.',
      official: true,
    },
    {
      q: 'Apa bedanya dengan Claude Design?',
      a: 'Claude Design adalah produk hosted yang terikat pada satu vendor. NamVu Design local-first, open source Apache-2.0, dan BYOK: Anda memakai agent, key, dan sistem DESIGN.md sendiri.',
    },
    {
      q: 'Apakah NamVu Design berjalan lokal?',
    ...
    },
    {
      ...
      a: 'Hanya prompt dan konteks skill Anda yang pergi ke provider yang key-nya Anda bawa (BYOK). NamVu Design tidak punya server sendiri — daemon bicara langsung dengan provider Anda. Artifact yang dihasilkan tersimpan sebagai file di direktori proyek, bukan di cloud vendor mana pun.',
    },
    {
      q: 'Bisakah memakai NamVu Design tanpa menginstal CLI atau app desktop?',
      a: 'Belum bisa. NamVu Design memang local-first — minimumnya adalah daemon lokal plus satu agent (Claude Code, Codex, Cursor, Gemini CLI, atau salah satu dari 17 adapter yang didukung). Sandbox hosted ada di roadmap tapi bukan prioritas: artifact di repo Anda lebih baik daripada dokumen di database orang lain.',
    },
    {
      q: 'Berapa biaya NamVu Design?',
      a: 'Produknya gratis dan Apache-2.0 — tidak ada langganan NamVu Design. Anda hanya membayar biaya API provider yang Anda pakai (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, dll.), ditagih langsung ke akun Anda. BYOK menjaga key dan pengeluaran tetap di sisi Anda.',
    },
    {
      q: 'Bisakah self-host NamVu Design di Vercel, Cloudflare, atau server sendiri?',
    ...
    {
      q: 'Bagaimana memindahkan brand saya ke NamVu Design?',
    ...
    {
      q: 'Apa saja di roadmap NamVu Design?',
  ...
  nl: [
    {
      q: 'Wat is NamVu Design?',
      a: 'NamVu Design is de officiële open-source AI design workspace van het project nexu-io/open-design. Het verandert een lokale coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode of Qwen — in een design-engine met combineerbare skills en draagbare DESIGN.md-systemen.',
    },
    {
      q: 'Is NamVu Design officieel?',
      a: 'Ja. De canonieke site is {origin} en de broncode staat op GitHub: {repo}. "NamVu Design", "OpenDesign", "open-design" en "NamVu Design AI" verwijzen naar hetzelfde project.',
      official: true,
    },
    {
      q: 'Wat is het verschil met Claude Design?',
      a: 'Claude Design is een hosted product van één leverancier. NamVu Design is local-first, Apache-2.0 open source en BYOK: je gebruikt je eigen agent, sleutels en DESIGN.md-systeem.',
    },
    {
      q: 'Draait NamVu Design lokaal?',
    ...
    },
    {
      ...
      a: 'Alleen je prompt en de skill-context gaan naar de provider waarvoor je zelf sleutels meebrengt (BYOK). NamVu Design heeft geen eigen server — de daemon praat rechtstreeks met je provider. Gegenereerde artifacts komen als bestanden in je projectdirectory terecht, niet in de cloud van een vendor.',
    },
    {
      q: 'Kan ik NamVu Design gebruiken zonder de CLI of desktop-app te installeren?',
      a: 'Vandaag niet. NamVu Design is bewust local-first — het minimum is een lokale daemon plus een agent (Claude Code, Codex, Cursor, Gemini CLI of een van de 17 ondersteunde adapters). Een gehoste sandbox staat op de roadmap maar is geen prioriteit: artifacts in je repo verslaan documenten in andermans database.',
    },
    {
      q: 'Wat kost NamVu Design?',
      a: 'Het product is gratis en Apache-2.0 — er bestaat geen NamVu Design-abonnement. Je betaalt alleen de API-kosten van de provider die je gebruikt (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, enz.), rechtstreeks via je eigen account. BYOK houdt zowel de sleutels als de uitgaven aan jouw kant.',
    },
    {
      q: 'Kan ik NamVu Design self-hosten op Vercel, Cloudflare of mijn eigen server?',
    ...
    {
      q: 'Hoe breng ik mijn merk naar NamVu Design?',
    ...
    {
      q: 'Wat staat er op de roadmap van NamVu Design?',
  ...
  ar: [
    {
      q: 'ما هو NamVu Design؟',
      a: 'NamVu Design هو مساحة عمل تصميم بالذكاء الاصطناعي رسمية ومفتوحة المصدر من مشروع nexu-io/open-design. يحوّل coding agent محلياً مثل Claude Code أو Codex أو Cursor أو Gemini CLI أو OpenCode أو Qwen إلى محرك تصميم يعمل عبر skills قابلة للتركيب وأنظمة DESIGN.md قابلة للنقل.',
    },
    {
      q: 'هل NamVu Design رسمي؟',
      a: 'نعم. الموقع canonical هو {origin} والمصدر على GitHub في {repo}. تشير "NamVu Design" و"OpenDesign" و"open-design" و"NamVu Design AI" إلى المشروع نفسه.',
      official: true,
    },
    {
      q: 'ما الفرق عن Claude Design؟',
      a: 'Claude Design منتج مستضاف مرتبط بمورّد واحد. NamVu Design محلي أولاً، مفتوح المصدر وفق Apache-2.0، وBYOK: تستخدم agent ومفاتيحك ونظام DESIGN.md الخاص بك.',
    },
    {
      q: 'هل يعمل NamVu Design محلياً؟',
    ...
    },
    {
      ...
      a: 'لا يذهب إلى المزوّد الذي تجلب مفاتيحه (BYOK) سوى الـ prompt وسياق الـ skills. لا يملك NamVu Design خادماً خاصاً به — يتواصل الـ daemon مع مزوّدك مباشرة. وتُحفظ الـ artifacts الناتجة كملفات في مجلد مشروعك، لا في سحابة أي مورّد.',
    },
    {
      q: 'هل يمكن استخدام NamVu Design دون تثبيت CLI أو تطبيق سطح المكتب؟',
      a: 'ليس حالياً. صُمم NamVu Design ليكون محلياً أولاً — الحد الأدنى هو daemon محلي مع agent واحد (Claude Code أو Codex أو Cursor أو Gemini CLI أو أحد الـ 17 adapter المدعومة). البيئة المستضافة موجودة في خارطة الطريق لكنها ليست أولوية: الـ artifacts في مستودعك أفضل من مستندات في قاعدة بيانات شخص آخر.',
    },
    {
      q: 'كم يكلّف NamVu Design؟',
      a: 'المنتج مجاني وبرخصة Apache-2.0 — لا يوجد اشتراك في NamVu Design. تدفع فقط تكاليف API للمزوّد الذي تستخدمه (Anthropic أو OpenAI أو Google أو Mistral أو xAI أو Moonshot وغيرها)، وتُحاسب مباشرة على حسابك. يبقي BYOK المفاتيح والإنفاق في جانبك.',
    },
    {
      q: 'هل يمكن استضافة NamVu Design ذاتياً على Vercel أو Cloudflare أو خادمي الخاص؟',
    ...
    {
      q: 'كيف أنقل علامتي التجارية إلى NamVu Design؟',
    ...
    {
      q: 'ماذا في خارطة طريق NamVu Design؟',
  ...
  tr: [
    {
      q: 'NamVu Design açık kaynaklı bir Claude Design alternatifi mi?',
      a: 'Evet — NamVu Design açık kaynaklı, yerel çalışan Claude Design alternatifidir. Claude Design kapalı, barındırılan ve Anthropic modellerine kilitliyken; NamVu Design Apache-2.0’dır, kendi makinende çalışır ve BYOK’tur: Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen ile çalıştır, her çıktıyı sana ait dosyalar olarak sakla.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Vibe design workspace nedir?',
      a: 'Vibe design workspace, her öğeyi elle yerleştirmek yerine bir yapay zeka ajanına niyetini anlatarak tasarım yaptığın yerdir — prompttan prototipe, web sayfasına, slaytlara veya HTML videoya. NamVu Design açık kaynaklı, agent-native bir vibe design workspace’tir: hâlihazırda kullandığın kodlama ajanını eksiksiz bir tasarım akışına bağlar; tek bir araç seni kaba bir fikirden sana ait, teslime hazır bir sonuca götürür.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'NamVu Design nedir?',
      a: "NamVu Design, nexu-io/open-design projesinin resmi açık kaynak AI design workspace'idir. Claude Code, Codex, Cursor, Gemini CLI, OpenCode veya Qwen gibi yerel coding agent'ları, birleştirilebilir skill'ler ve taşınabilir DESIGN.md sistemleriyle çalışan bir tasarım motoruna dönüştürür.",
    },
    {
      q: 'NamVu Design resmi mi?',
      a: 'Evet. Kanonik site {origin}, kaynak kod GitHub üzerinde {repo}. "NamVu Design", "OpenDesign", "open-design" ve "NamVu Design AI" aynı projeyi anlatır.',
      official: true,
    },
    {
      q: "Claude Design'dan farkı ne?",
      a: 'Claude Design tek bir vendor’a bağlı hosted bir üründür. NamVu Design local-first, Apache-2.0 açık kaynak ve BYOK’tur: kendi agent’ını, anahtarlarını ve DESIGN.md sistemini kullanırsın.',
    },
    {
      q: 'NamVu Design yerelde çalışır mı?',
    ...
    },
    {
      ...
      a: 'Yalnızca prompt\'unuz ve skill bağlamı, anahtarlarını kendinizin getirdiği (BYOK) sağlayıcıya gider. NamVu Design\'ın kendi sunucusu yoktur — daemon doğrudan sağlayıcınızla konuşur. Üretilen artifact\'ler herhangi bir vendor bulutuna değil, proje dizininize dosya olarak düşer.',
    },
    {
      q: 'CLI veya desktop app kurmadan NamVu Design kullanılabilir mi?',
      a: 'Bugün için hayır. NamVu Design tasarımı gereği local-first\'tür — minimum, yerel bir daemon artı bir agent\'tır (Claude Code, Codex, Cursor, Gemini CLI veya desteklenen 17 adapter\'dan biri). Hosted bir sandbox roadmap\'te var ama öncelik değil: repo\'nuzdaki artifact\'ler, başkasının veritabanındaki belgelerden iyidir.',
    },
    {
      q: 'NamVu Design\'ın maliyeti nedir?',
      a: 'Ürün ücretsiz ve Apache-2.0 lisanslıdır — NamVu Design aboneliği yoktur. Yalnızca kullandığınız sağlayıcının (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot vb.) API maliyetini ödersiniz; doğrudan kendi hesabınıza faturalandırılır. BYOK hem anahtarları hem harcamayı sizin tarafınızda tutar.',
    },
    {
      q: 'NamVu Design\'ı Vercel, Cloudflare veya kendi sunucumda self-host edebilir miyim?',
    ...
    {
      q: 'Markamı NamVu Design\'a nasıl taşırım?',
    ...
    {
      q: 'NamVu Design roadmap\'inde neler var?',
  ...
  uk: [
    {
      q: 'Що таке NamVu Design?',
      a: 'NamVu Design — офіційний open-source AI design workspace проєкту nexu-io/open-design. Він перетворює локальний coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode або Qwen — на design-двигун із composable skills і переносними DESIGN.md-системами.',
    },
    {
      q: 'NamVu Design офіційний?',
      a: 'Так. Канонічний сайт — {origin}, вихідний код на GitHub: {repo}. "NamVu Design", "OpenDesign", "open-design" і "NamVu Design AI" означають один проєкт.',
      official: true,
    },
    {
      q: 'Чим він відрізняється від Claude Design?',
      a: 'Claude Design — hosted-продукт одного вендора. NamVu Design — local-first, Apache-2.0 open source і BYOK: ви використовуєте свого agent, свої ключі та свою DESIGN.md-систему.',
    },
    {
      q: 'NamVu Design запускається локально?',
    ...
    },
    {
      ...
      a: 'Провайдеру, чиї ключі ви принесли (BYOK), іде лише ваш prompt і контекст skills. В NamVu Design немає власного сервера — daemon спілкується з вашим провайдером напряму. Generated artifacts зберігаються файлами в папці проєкту, а не в хмарі вендора.',
    },
    {
      q: 'Чи можна користуватися NamVu Design без встановлення CLI чи desktop-застосунку?',
      a: 'Поки ні. NamVu Design за задумом local-first — мінімум це локальний daemon плюс agent (Claude Code, Codex, Cursor, Gemini CLI або один із 17 підтримуваних adapters). Hosted-пісочниця є в роадмапі, але не в пріоритеті: artifacts у вашому репозиторії кращі за документи в чужій базі даних.',
    },
    {
      q: 'Скільки коштує NamVu Design?',
      a: 'Продукт безплатний і під Apache-2.0 — підписки NamVu Design не існує. Ви платите лише за API того провайдера, яким користуєтеся (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot тощо), напряму зі свого акаунта. BYOK залишає і ключі, і витрати на вашому боці.',
    },
    {
      q: 'Чи можна self-host NamVu Design на Vercel, Cloudflare або власному сервері?',
    ...
    {
      q: 'Як перенести свій бренд в NamVu Design?',
...
const HOME_PAGE_COPY_EN: HomePageCopy = {
  rail: {
    right: 'NamVu Design — Vol. 01 · Issue Nº 26 · Apache-2.0',
    left: 'Skills · Systems · Agents · BYOK · Local-first',
  },
  hero: {
    discordAria: 'Join the NamVu Design Discord',
    ...
    lead: (skills, systems) =>
      `NamVu Design is the official, local-first alternative to Claude Design. Your existing coding agent — Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen — becomes the design engine, driven by ${skills} composable skills and ${systems} portable DESIGN.md systems.`,
  ...
  official: {
    aria: 'Official NamVu Design sources',
  ...
  about: {
    ...
    caption: 'Studies in form · perception · machine imagination. (NamVu Design, MMXXVI)',
  },
  capabilities: {
  ...
  work: {
    ...
    editedBy: 'Edited by NamVu Design',
    label: 'Selected work',
  ...
  testimonial: {
    ...
    label: 'Collaborators',
    quote:
      '“NamVu Design helped us turn vague AI ideas into a visual system that felt sharp, believable, and genuinely new.”',
  ...
  footer: {
    ...
    downloadAria: 'Download the NamVu Design desktop app',
    download: 'Download desktop',
    columns: {
      studio: 'Studio',
      library: 'Library',
      connect: 'Connect',
      openDesign: 'NamVu Design',
    },
    ...
    bottomLeft: 'NamVu Design · Apache-2.0 · 2026 / Volume 01 / Issue Nº 26',
...
const HOME_PAGE_COPY: Partial<Record<LandingLocaleCode, HomePageCopy>> = {
  ...
  zh: {
    rail: {
      right: 'NamVu Design — 第 01 卷 · 第 26 期 · Apache-2.0',
      left: 'Skills · UIUX Design · Agents · BYOK · 本地优先',
    },
    hero: {
      discordAria: '加入 NamVu Design Discord',
      ...
      lead: (skills) =>
        `NamVu Design 是官方、本地优先的 Claude Design 替代方案。你现有的编码 Agent —— Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen —— 会变成设计引擎，并由 ${skills} 个可组合 SKILL.md 工作流驱动。`,
      star: 'Download',
      download: '下载桌面端',
      plate: '图版 Nº 08',
      composedIn: '由',
    ...
    about: {
      ...
      caption: '形式 · 感知 · 机器想象力研究。（NamVu Design，MMXXVI）',
    },
    capabilities: {
      rule: '能力 · Skill · 规范',
    ...
    testimonial: {
      ...
      shoulders: '站在前人的肩膀上',
      label: '协作者',
      quote: '来自全球，100+ 贡献者正在一起构建 NamVu Design',
      authorName: 'Mina Kovac',
    ...
    footer: {
      ...
      downloadAria: '下载 NamVu Design 桌面应用',
      download: '下载桌面端',
      columns: {
        studio: '工作室',
        library: 'Skill',
    ...
    libraryLinks: {
      ...
      bottomLeft: 'NamVu Design · Apache-2.0 · 2026 / 第 01 卷 / 第 26 期',
...
HOME_PAGE_COPY['zh-tw'] = {
  ...
  hero: {
    ...
    titleSecondEmphasis: '你自己的 Agent 上',
    lead: (skills, systems) =>
      `NamVu Design 是官方、本地優先的 Claude Design 替代方案。你現有的 coding agent —— Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen —— 會變成設計引擎，並由 ${skills} 個可組合 Skill 與 ${systems} 套可攜式 DESIGN.md 系統驅動。`,
  ...
  about: {
    ...
    caption: '形式 · 感知 · 機器想像力研究。（NamVu Design，MMXXVI）',
  },
  capabilities: {
  ...
  testimonial: {
    ...
    shoulders: '站在前人的肩膀上',
    label: '協作者',
    quote: '“NamVu Design 幫我們把模糊的 AI 想法變成了一個視覺系統：鋒利、可信，而且真的有新意。”',
  ...
  footer: {
    ...
    downloadAria: '下載 NamVu Design 桌面應用',
    download: '下載桌面端',
    columns: {
      studio: '工作室',
      library: '資源庫',
...
const LANDING_UI_COPY: LandingUiCopy = {
  ...
  blog: {
    title: 'Blog',
    seoTitle: 'Blog — NamVu Design',
    description:
      'Notes to help you understand, explore, and build with NamVu Design — across product, guides, use cases, and community.',
  ...
  tutorials: {
    title: 'NamVu Design Tutorials',
    seoTitle: 'NamVu Design Tutorials — Free Video Guides & How-Tos',
    description:
      'Learn how to use NamVu Design with step-by-step video tutorials — getting started, plugins, design systems, and real workflows. Every guide plays right on the page.',
    ...
    contributeTitle: 'Made an NamVu Design tutorial?',
    contributeBody:
    ...
    detailTitle: (title) => `${title} — NamVu Design Tutorials`,
  ...
  catalog: {
    ...
    skills: {
      title: (count) => `Skills — ${count} composable design capabilities | NamVu Design`,
      description:
        'Browse the full NamVu Design skills catalog: 100+ file-based SKILL.md bundles spanning decks, prototypes, dashboards, mobile flows, video, and live artifacts. Each skill is a folder you drop into the daemon.',
      label: 'Catalog · Nº 01',
      ...
      featured: 'Featured',
      allAria: 'All skills',
      detailTitle: (name) => `${name} — NamVu Design skill`,
      detailFallbackDescription: (name) => `NamVu Design skill bundle: ${name}.`,
      detailLabel: 'Skill',
      ...
      filterTitle: (heading, count) =>
        `${heading} skills — ${count} NamVu Design ${heading.toLowerCase()} agents`,
      modeDescription: (heading, count) =>
        `Every NamVu Design skill that produces ${heading.toLowerCase()} artifacts. ${count} ready-to-run, system-aware agents — installable through the daemon, brand-locked through any DESIGN.md system.`,
      scenarioDescription: (heading, count) =>
        `Every NamVu Design skill in the ${heading.toLowerCase()} scenario. ${count} ready-to-run agents covering decks, prototypes, templates, and live artifacts — all brand-locked through any DESIGN.md.`,
    ...
    systems: {
      title: (count) => `Design Systems — ${count} portable visual systems | NamVu Design`,
      description:
        'Browse the full NamVu Design design systems catalog: 100+ DESIGN.md token bundles spanning editorial, productivity, brand, futuristic, and minimalist systems. Pick one in the daemon top-bar and every skill renders in that visual language.',
      label: 'Catalog · Nº 02',
      ...
      category: 'Category',
      allAria: 'All systems',
      detailTitle: (name) => `${name} — NamVu Design design system`,
      detailFallbackDescription: (name, category) =>
        `NamVu Design system bundle: ${name}, ${category}.`,
      ...
      categoryDescription: (heading, count) =>
        `Every NamVu Design design system tagged ${heading.toLowerCase()}. ${count} portable DESIGN.md token bundles — ready to pair with any skill in the catalog for instant brand-grade output.`,
    ...
    templates: {
      title: (count) => `Templates — ${count} ready-to-fork artifact templates | NamVu Design`,
      description:
      ...
      detailTitle: (name) => `${name} — NamVu Design template`,
    ...
    craft: {
      title: (count) => `Craft — ${count} brand-agnostic rendering principles | NamVu Design`,
      description:
        'Universal craft rules every NamVu Design skill can opt into: accessibility, animation discipline, color, form validation, laws of UX, RTL/Bidi, state coverage, and typography hierarchy.',
      label: 'Catalog · Nº 03',
      ...
      detailTitle: (name) => `${name} — NamVu Design craft principle`,
      detailFallbackDescription: (name) => `NamVu Design craft rule: ${name}.`,
  ...
  plugins: {
    registryTitle: 'NamVu Design Plugins — Official and community registries',
    registryDescription: (count) =>
      `Browse ${count} NamVu Design plugins from official and community registries. Search installable agent-native design workflows with stable vendor/plugin IDs.`,
    directoryRailRight: 'NamVu Design Registry · Official · Community',
    ...
    details: 'Details',
    detailTitle: (title) => `${title} — NamVu Design Plugin`,
    detailDescription: (description, command) => `${description} Install with ${command}.`,
    detailRailRight: (id) => `NamVu Design Plugin · ${id}`,
...
> = {
  zh: {
    ...
    blog: {
      title: '博客',
      seoTitle: '博客 — NamVu Design',
      description:
        '理解、探索和构建 NamVu Design 的笔记，覆盖产品、指南、使用场景与社区。',
    ...
    tutorials: {
      title: '教程',
      seoTitle: '教程 — NamVu Design',
      description:
        '观看 NamVu Design 的上手 walkthrough、插件教程、演示、评测与社区视频。所有视频都在页面内播放，并保留原始 YouTube 来源。',
      ...
      contributeTitle: '做过 NamVu Design 的教程？',
      contributeBody:
        '把你的视频分享给社区——在简单的表单里贴个链接就行，维护者会把它加到这个页面。',
      contributeCta: '提交一个教程 ↗',
      contributeSuggest: '想直接提 PR？↗',
      thumbnailAlt: (title) => `${title} 的视频封面`,
      detailTitle: (title) => `${title} — NamVu Design 教程`,
      localizedTitle: (_title, author) => `NamVu Design 教程：${author}`,
      localizedSummary: (_title, author, category) =>
        `${author} 通过一段 ${category} 视频讲解 NamVu Design 的本地优先设计工作流、Skill、设计系统与可复用模板。`,
      localizedBodyHtml: (_title, author, summary) =>
        `<p>${summary}</p><h2>本地化摘要</h2><p>这段视频来自 ${author}，围绕 NamVu Design 的安装、能力演示、设计系统、Skill 和本地 Agent 工作流展开。页面保留原始视频来源，非英文页面使用站内 i18n 摘要，让正文不会回退成英文。</p>`,
    },
    catalog: {
      skills: {
        title: (count) => `Skill — ${count} 个可组合设计能力 | NamVu Design`,
        description:
          '浏览完整的 NamVu Design Skill 目录：100+ 个基于 SKILL.md 的文件夹，覆盖演示文稿、原型、数据看板、移动流程、视频与实时 Artifact。每个 Skill 都是一个可放入 daemon 的文件夹。',
        label: '目录 · Nº 01',
        ...
        allAria: '全部 Skill',
        detailTitle: (name) => `${name} — NamVu Design Skill`,
        detailFallbackDescription: (name) => `NamVu Design Skill 包：${name}。`,
        detailLabel: 'Skill',
        ...
        related: '相关 Skill',
        filterTitle: (heading, count) =>
          `${heading} Skill — ${count} 个 NamVu Design ${heading.toLowerCase()} Agent`,
        modeDescription: (heading, count) =>
          `所有生成 ${heading.toLowerCase()} Artifact 的 NamVu Design Skill。${count} 个可直接运行、读取系统上下文的 Agent，可以通过 daemon 安装，并通过任意 DESIGN.md 系统锁定品牌。`,
        scenarioDescription: (heading, count) =>
          `${heading.toLowerCase()} 场景下的全部 NamVu Design Skill。${count} 个可运行 Agent，覆盖演示文稿、原型、模板与实时 Artifact，并可通过任意 DESIGN.md 锁定品牌。`,
        modeHeading: (heading, count) =>
      ...
      systems: {
        title: (count) => `设计系统 — ${count} 套可移植视觉系统 | NamVu Design`,
        description:
          '浏览完整的 NamVu Design 设计系统目录：100+ 个 DESIGN.md token 包，覆盖 editorial、productivity、brand、futuristic 与 minimalist 等系统。你可以在 daemon 顶栏选择一个系统，让所有 Skill 以同一种视觉语言渲染。',
        label: '目录 · Nº 02',
        ...
        category: '分类',
        allAria: '全部设计系统',
        detailTitle: (name) => `${name} — NamVu Design 设计系统`,
        detailFallbackDescription: (name, category) =>
          `NamVu Design 系统包：${name}，${category}。`,
        detailLabel: '设计系统',
        ...
        categoryDescription: (heading, count) =>
          `所有标记为 ${heading.toLowerCase()} 的 NamVu Design 设计系统。${count} 套可移植 DESIGN.md token 包，可与目录中任意 Skill 搭配，快速得到品牌级输出。`,
        categoryHeading: (heading, count) =>
      ...
      templates: {
        title: (count) => `模板 — ${count} 个可 fork 的 Artifact 模板 | NamVu Design`,
        description:
        ...
        detailTitle: (name) => `${name} — NamVu Design 模板`,
        detailLabel: '模板',
      ...
      craft: {
        title: (count) => `工艺规则 — ${count} 条品牌无关渲染原则 | NamVu Design`,
        description:
          '每个 NamVu Design Skill 都可以声明要加载的通用工艺规则：无障碍、动画纪律、颜色、表单验证、UX 法则、RTL/Bidi、状态覆盖和字体层级。',
        label: '目录 · Nº 03',
        heading: (count) => `工艺规则 — ${count} 条品牌无关渲染原则。`,
        lead:
          'Skill 会声明它需要哪些工艺规则。Agent 会把匹配的规则加载进系统提示，让无障碍、动效、颜色和字体等质量要求在不同视觉系统中保持不变。',
        allAria: '全部工艺规则',
        detailTitle: (name) => `${name} — NamVu Design 工艺规则`,
        detailFallbackDescription: (name) => `NamVu Design 工艺规则：${name}。`,
        detailLabel: '工艺规则',
    ...
    plugins: {
      registryTitle: 'NamVu Design 插件 — 官方与社区注册表',
      registryDescription: (count) =>
        `浏览来自官方与社区注册表的 ${count} 个 NamVu Design 插件。搜索可安装的 Agent 原生设计工作流，每个条目都有稳定的 vendor/plugin ID。`,
      directoryRailRight: 'NamVu Design 注册表 · 官方 · 社区',
      directoryRailLeft: 'vendor/plugin-name · marketplace.json',
      topbarTitle: 'OD / 注册表',
      topbarSubtitle: '公开索引',
      ...
      details: '详情',
      detailTitle: (title) => `${title} — NamVu Design 插件`,
      detailDescription: (description, command) => `${description} 使用 ${command} 安装。`,
      detailRailRight: (id) => `NamVu Design 插件 · ${id}`,
      allPlugins: '全部插件',
      registry: '注册表',
      deprecated: '已弃用',
      yanked: '已下架',
  ...
  'zh-tw': {
    ...
    blog: {
      title: '部落格',
      seoTitle: '部落格 — NamVu Design',
      description:
        '理解、探索與建構 NamVu Design 的筆記，涵蓋產品、指南、使用場景與社群。',
    ...
    tutorials: {
      title: '教學',
      seoTitle: '教學 — NamVu Design',
      description:
        '觀看 NamVu Design 的上手 walkthrough、外掛教學、演示、評測與社群影片。所有影片都在頁面內播放，並保留原始 YouTube 來源。',
      ...
      contributeTitle: '做過 NamVu Design 的教學？',
      contributeBody:
        '把你的影片分享給社群——在簡單的表單裡貼個連結就行，維護者會把它加到這個頁面。',
      contributeCta: '提交一個教學 ↗',
      contributeSuggest: '想直接提 PR？↗',
      thumbnailAlt: (title) => `${title} 的影片封面`,
      detailTitle: (title) => `${title} — NamVu Design 教學`,
      localizedTitle: (_title, author) => `NamVu Design 教學：${author}`,
      localizedSummary: (_title, author, category) =>
        `${author} 透過一支 ${category} 影片講解 NamVu Design 的本地優先設計工作流、Skill、設計系統與可複用模板。`,
      localizedBodyHtml: (_title, author, summary) =>
        `<p>${summary}</p><h2>本地化摘要</h2><p>這支影片來自 ${author}，圍繞 NamVu Design 的安裝、能力演示、設計系統、Skill 與本地 Agent 工作流展開。頁面保留原始影片來源，非英文頁面使用站內 i18n 摘要，避免正文回退成英文。</p>`,
    },
  },
};
...
const HOME_PAGE_COPY_OVERRIDES: Partial<Record<LandingLocaleCode, DeepPartial<HomePageCopy>>> = {
  ja: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design は公式のローカル優先 Claude Design 代替です。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen など既存の coding agent が、${skills} 個の composable skill と ${systems} 個の portable DESIGN.md system で動くデザインエンジンになります。`,
      star: 'GitHub で Star',
    ...
    faqSection: { rule: 'FAQ', answers: '公式回答', label: 'NamVu Design よくある質問', titlePrefix: '', titleMiddle: 'と', titleSuffix: 'Claude Design のオープンソース代替について' },
  ...
  ko: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design은 공식 local-first Claude Design 대안입니다. 이미 쓰는 Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen 같은 coding agent가 ${skills}개의 조합형 skill과 ${systems}개의 portable DESIGN.md system으로 구동되는 디자인 엔진이 됩니다.`,
      star: 'GitHub에서 Star',
      download: '데스크톱 다운로드',
    },
    ...
    faqSection: { rule: 'FAQ', answers: '공식 답변', label: 'NamVu Design 자주 묻는 질문', titlePrefix: '', titleMiddle: '및', titleSuffix: 'Claude Design 오픈소스 대안 질문' },
  ...
  de: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design ist die offizielle local-first Alternative zu Claude Design. Dein vorhandener Coding-Agent — Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen — wird zur Design-Engine, gesteuert von ${skills} kombinierbaren Skills und ${systems} portablen DESIGN.md-Systemen.`,
  ...
  fr: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design est l'alternative officielle, local-first, à Claude Design. Votre agent de coding — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design piloté par ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Réponses officielles', label: 'FAQ NamVu Design', titlePrefix: 'Questions sur', titleMiddle: 'et', titleSuffix: "l'alternative open source à Claude Design" },
  ...
  ru: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится design engine на базе ${skills} composable skills и ${systems} portable DESIGN.md systems.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Официальные ответы', label: 'Вопросы об NamVu Design', titlePrefix: 'Вопросы про', titleMiddle: 'и', titleSuffix: 'open-source альтернативу Claude Design' },
  ...
  es: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design es la alternativa oficial, local-first, a Claude Design. Tu coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Respuestas oficiales', label: 'FAQ de NamVu Design', titlePrefix: 'Preguntas sobre', titleMiddle: 'y', titleSuffix: 'la alternativa open source a Claude Design' },
  ...
  'pt-br': {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design é a alternativa oficial, local-first, ao Claude Design. Seu coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Respostas oficiais', label: 'FAQ NamVu Design', titlePrefix: 'Perguntas sobre', titleMiddle: 'e', titleSuffix: 'a alternativa open source ao Claude Design' },
  ...
  it: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design è l'alternativa ufficiale, local-first, a Claude Design. Il tuo coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Risposte ufficiali', label: 'FAQ NamVu Design', titlePrefix: 'Domande su', titleMiddle: 'e', titleSuffix: "l'alternativa open source a Claude Design" },
  ...
  vi: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design là lựa chọn chính thức, local-first, thay Claude Design. Coding agent bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Câu trả lời chính thức', label: 'FAQ NamVu Design', titlePrefix: 'Câu hỏi về', titleMiddle: 'và', titleSuffix: 'lựa chọn mã nguồn mở thay Claude Design' },
  ...
  pl: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design to oficjalna, local-first alternatywa dla Claude Design. Twój coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Oficjalne odpowiedzi', label: 'FAQ NamVu Design', titlePrefix: 'Pytania o', titleMiddle: 'i', titleSuffix: 'open-source alternatywę dla Claude Design' },
  ...
  id: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design adalah alternatif resmi, local-first, untuk Claude Design. Coding agent yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Jawaban resmi', label: 'FAQ NamVu Design', titlePrefix: 'Pertanyaan tentang', titleMiddle: 'dan', titleSuffix: 'alternatif open source untuk Claude Design' },
  ...
  nl: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design is het officiële local-first alternatief voor Claude Design. Je bestaande coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
      star: 'Star op GitHub',
    ...
    faqSection: { rule: 'FAQ', answers: 'Officiële antwoorden', label: 'NamVu Design-FAQ', titlePrefix: 'Vragen over', titleMiddle: 'en', titleSuffix: 'het open-source alternatief voor Claude Design' },
  ...
  ar: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول coding agent الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم مدفوع بـ ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'إجابات رسمية', label: 'أسئلة NamVu Design', titlePrefix: 'أسئلة حول', titleMiddle: 'و', titleSuffix: 'البديل مفتوح المصدر لـ Claude Design' },
  ...
  tr: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design, Claude Design'ın resmi local-first alternatifidir. Zaten kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle çalışan bir tasarım motoruna dönüşür.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Resmi yanıtlar', label: 'NamVu Design SSS', titlePrefix: '', titleMiddle: 've', titleSuffix: "Claude Design'ın açık kaynak alternatifi hakkında sorular" },
  ...
  uk: {
    hero: {
      ...
      lead: (skills, systems) =>
        `NamVu Design — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine на базі ${skills} composable skills і ${systems} portable DESIGN.md systems.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Офіційні відповіді', label: 'FAQ NamVu Design українською', titlePrefix: 'Питання про', titleMiddle: 'і', titleSuffix: 'open-source альтернативу Claude Design' },
...
> = {
  ja: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / 第 01 巻 / 第 26 号',
  ...
  ko: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / 01권 / 26호',
  ...
  de: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Band 01 / Ausgabe Nr. 26',
  ...
  fr: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Volume 01 / Numéro 26',
  ...
  ru: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Том 01 / Выпуск № 26',
  ...
  es: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Volumen 01 / Número 26',
  ...
  'pt-br': {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Volume 01 / Edição Nº 26',
  ...
  it: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Volume 01 / Numero 26',
  ...
  vi: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Tập 01 / Số 26',
  ...
  pl: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Tom 01 / Numer 26',
  ...
  id: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Volume 01 / Edisi Nº 26',
  ...
  nl: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Volume 01 / Editie Nº 26',
  ...
  ar: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / المجلد 01 / العدد 26',
  ...
  tr: {
    ...
    htmlVideo: 'HTML Video',
    nexuIo: 'nexu.io',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Cilt 01 / Sayı Nº 26',
  ...
  uk: {
    ...
    htmlVideo: 'HTML Video',
    nexuIo: 'nexu.io',
    bottomLeft: '● NamVu Design · Apache-2.0 · 2026 / Том 01 / Випуск № 26',
...
> = {
  ja: {
    ...
    downloadAria: 'NamVu Design デスクトップアプリをダウンロード',
    download: 'デスクトップをダウンロード',
    columns: { studio: 'スタジオ', library: 'ライブラリ', connect: '接続', openDesign: 'NamVu Design' },
  ...
  ko: {
    ...
    downloadAria: 'NamVu Design 데스크톱 앱 다운로드',
    download: '데스크톱 다운로드',
    columns: { studio: '스튜디오', library: '라이브러리', connect: '연결', openDesign: 'NamVu Design' },
  ...
  de: {
    ...
    download: 'Desktop herunterladen',
    columns: { studio: 'Studio', library: 'Bibliothek', connect: 'Verbinden', openDesign: 'NamVu Design' },
  ...
  fr: {
    ...
    downloadAria: "Télécharger l'application desktop NamVu Design",
    download: 'Télécharger le desktop',
    columns: { studio: 'Studio', library: 'Bibliothèque', connect: 'Connexion', openDesign: 'NamVu Design' },
  ...
  ru: {
    ...
    downloadAria: 'Скачать настольное приложение NamVu Design',
    download: 'Скачать desktop',
    columns: { studio: 'Студия', library: 'Библиотека', connect: 'Связь', openDesign: 'NamVu Design' },
  ...
  es: {
    ...
    downloadAria: 'Descargar la aplicación de escritorio de NamVu Design',
    download: 'Descargar desktop',
    columns: { studio: 'Estudio', library: 'Biblioteca', connect: 'Conectar', openDesign: 'NamVu Design' },
  ...
  'pt-br': {
    ...
    downloadAria: 'Baixar o aplicativo desktop do NamVu Design',
    download: 'Baixar desktop',
    columns: { studio: 'Estúdio', library: 'Biblioteca', connect: 'Conectar', openDesign: 'NamVu Design' },
  ...
  it: {
    ...
    downloadAria: "Scarica l'app desktop di NamVu Design",
    download: 'Scarica desktop',
    columns: { studio: 'Studio', library: 'Libreria', connect: 'Connessione', openDesign: 'NamVu Design' },
  ...
  vi: {
    ...
    downloadAria: 'Tải ứng dụng desktop NamVu Design',
    download: 'Tải desktop',
    columns: { studio: 'Studio', library: 'Thư viện', connect: 'Kết nối', openDesign: 'NamVu Design' },
  ...
  pl: {
    ...
    downloadAria: 'Pobierz aplikację desktop NamVu Design',
    download: 'Pobierz desktop',
    columns: { studio: 'Studio', library: 'Biblioteka', connect: 'Kontakt', openDesign: 'NamVu Design' },
  ...
  id: {
    ...
    downloadAria: 'Unduh aplikasi desktop NamVu Design',
    download: 'Unduh desktop',
    columns: { studio: 'Studio', library: 'Pustaka', connect: 'Koneksi', openDesign: 'NamVu Design' },
  ...
  nl: {
    ...
    downloadAria: 'Download de NamVu Design desktop-app',
    download: 'Desktop downloaden',
    columns: { studio: 'Studio', library: 'Bibliotheek', connect: 'Verbinden', openDesign: 'NamVu Design' },
  ...
  ar: {
    ...
    downloadAria: 'تنزيل تطبيق NamVu Design لسطح المكتب',
    download: 'تنزيل سطح المكتب',
    columns: { studio: 'الاستوديو', library: 'المكتبة', connect: 'التواصل', openDesign: 'NamVu Design' },
  ...
  tr: {
    ...
    downloadAria: 'NamVu Design desktop uygulamasını indir',
    download: 'Desktop indir',
    columns: { studio: 'Stüdyo', library: 'Kütüphane', connect: 'Bağlantı', openDesign: 'NamVu Design' },
  ...
  uk: {
    ...
    downloadAria: 'Завантажити настільний застосунок NamVu Design',
    download: 'Завантажити desktop',
    columns: { studio: 'Студія', library: 'Бібліотека', connect: "Зв'язок", openDesign: 'NamVu Design' },
...
const LOCALIZED_HOME_BODY_COPY: Partial<Record<LandingLocaleCode, DeepPartial<HomePageCopy>>> = {
  ja: homeFallbackCopy({
    railRight: 'NamVu Design — 第 01 巻 · 第 26 号 · Apache-2.0',
    railLeft: 'Skill · Design System · Agent · BYOK · ローカル優先',
    discordAria: 'NamVu Design Discord に参加',
    ...
    heroLead: (skills, systems) =>
      `NamVu Design は Claude Design の公式ローカル優先代替です。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen など既存の coding agent が、${skills} 個の組み合わせ可能な Skill と ${systems} 個のポータブル DESIGN.md システムで動くデザインエンジンになります。`,
    star: 'GitHub で Star',
    download: 'デスクトップをダウンロード',
    plate: '図版 Nº 08',
    composedIn: '構成',
    ...
    officialAria: 'NamVu Design の公式ソース',
    officialLabel: '公式ソース',
    officialItems: [
    ...
    about: {
      ...
      caption: '形 · 知覚 · 機械の想像力の研究。（NamVu Design, MMXXVI）',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      shoulders: '先人の肩の上に立つ',
      label: '協働者',
      quote: '「NamVu Design は曖昧な AI のアイデアを、鋭く、信頼でき、本当に新しい視覚システムへ変えてくれました。」',
...
LOCALIZED_HOME_BODY_COPY.ko = homeFallbackCopy({
  railRight: 'NamVu Design — 01권 · 26호 · Apache-2.0',
  railLeft: 'Skill · 디자인 시스템 · Agent · BYOK · 로컬 우선',
  discordAria: 'NamVu Design Discord 참여',
  ...
  heroLead: (skills, systems) =>
    `NamVu Design은 Claude Design의 공식 로컬 우선 대안입니다. Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen 같은 기존 coding agent가 ${skills}개의 조합 가능한 Skill과 ${systems}개의 portable DESIGN.md 시스템으로 움직이는 디자인 엔진이 됩니다.`,
  star: 'GitHub에서 Star',
  download: '데스크톱 다운로드',
  plate: '도판 Nº 08',
  composedIn: '구성',
  ...
  officialAria: 'NamVu Design 공식 출처',
  officialLabel: '공식 출처',
  officialItems: [
  ...
  about: {
    ...
    caption: '형태 · 지각 · 기계적 상상력 연구. (NamVu Design, MMXXVI)',
  },
  capabilities: {
  ...
  testimonial: {
    ...
    label: '협업자',
    quote: '“NamVu Design은 모호한 AI 아이디어를 날카롭고 믿을 수 있으며 실제로 새로운 시각 시스템으로 바꾸어 주었습니다.”',
...
LOCALIZED_HOME_BODY_COPY.de = homeFallbackCopy({
  railRight: 'NamVu Design — Band 01 · Ausgabe Nr. 26 · Apache-2.0',
  railLeft: 'Skills · Systeme · Agents · BYOK · lokal zuerst',
  discordAria: 'NamVu Design Discord beitreten',
  ...
  heroLead: (skills, systems) =>
    `NamVu Design ist die offizielle lokal zuerst gedachte Alternative zu Claude Design. Dein vorhandener Coding-Agent — Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen — wird zur Design-Engine mit ${skills} kombinierbaren Skills und ${systems} portablen DESIGN.md-Systemen.`,
  star: 'Auf GitHub sternen',
  download: 'Desktop herunterladen',
  plate: 'Tafel Nr. 08',
  ...
  about: {
    ...
    caption: 'Studien zu Form · Wahrnehmung · maschinischer Vorstellungskraft. (NamVu Design, MMXXVI)',
  },
  capabilities: {
  ...
  work: {
    ...
    editedBy: 'Redaktion NamVu Design',
  ...
  testimonial: {
    ...
    label: 'Mitwirkende',
    quote: '„NamVu Design half uns, vage KI-Ideen in ein visuelles System zu verwandeln, das scharf, glaubwürdig und wirklich neu wirkte.“',

...
const de: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: 'NamVu Design herunterladen',
  heroAlt:
  ...
  schemaRelationQuestion: 'Hat Codex Slides mit NamVu Design zu tun?',
  schemaRelationAnswer:
    'Ja. Codex Slides ist ein Schwesterprojekt des Teams hinter NamVu Design — derselbe offene, local-first, agent-native Ansatz, angewandt auf Präsentationen statt auf Designdateien.',
};

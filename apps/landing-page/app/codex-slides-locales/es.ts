...
const es: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: "Descargar NamVu Design",
  heroAlt:
  ...
  schemaRelationQuestion: "¿Codex Slides tiene relación con NamVu Design?",
  schemaRelationAnswer:
    "Sí. Codex Slides es un proyecto hermano del equipo que hay detrás de NamVu Design: el mismo enfoque abierto, local-first y agent-native aplicado a las presentaciones en lugar de a los archivos de diseño.",
};

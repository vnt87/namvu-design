...
const fr: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: "Télécharger NamVu Design",
  heroAlt:
  ...
  schemaRelationQuestion: "Codex Slides est-il lié à NamVu Design ?",
  schemaRelationAnswer:
    "Oui. Codex Slides est un projet frère porté par l'équipe derrière NamVu Design — la même approche ouverte, local-first et agent-native, appliquée aux présentations plutôt qu'aux fichiers de design.",
};

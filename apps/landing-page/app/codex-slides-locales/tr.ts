...
const tr: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: "NamVu Design'ı indir",
  heroAlt:
  ...
  tiebackTitle: "NamVu Design ailesinden",
  tiebackBody:
    "NamVu Design, hâlihazırda kullandığın kodlama ajanının dışında duran açık ve local-first tasarım çalışma alanıdır. Codex Slides ise aynı fikrin sunumlara çevrilmiş hali: ajanın işi açıkta yapar, proje senin makinende kalır ve hiçbir şey bir aboneliğin arkasına kilitlenmez. Slaytların ötesindeki tam tasarım araç seti için NamVu Design uygulamasını edin.",
  ...
  schemaRelationQuestion: "Codex Slides, NamVu Design ile ilişkili mi?",
  schemaRelationAnswer:
    "Evet. Codex Slides, NamVu Design'ın arkasındaki ekibin kardeş projesidir — aynı açık, local-first ve agent-native yaklaşımın tasarım dosyaları yerine sunumlara uygulanmış hali.",
};

...
const it: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: "Scarica NamVu Design",
  heroAlt:
  ...
  tiebackTitle: "Dalla famiglia NamVu Design",
  tiebackBody:
    "NamVu Design è lo spazio di design aperto e local-first che sta fuori dal coding agent che già usi. Codex Slides è la stessa idea puntata sulle presentazioni: il tuo agente lavora allo scoperto, il progetto resta sulla tua macchina e nulla finisce chiuso dietro un abbonamento. Per l'intero toolkit di design oltre le slide, scarica l'app NamVu Design.",
  ...
  schemaRelationQuestion: "Codex Slides ha a che fare con NamVu Design?",
  schemaRelationAnswer:
    "Sì. Codex Slides è un progetto gemello nato dal team dietro NamVu Design: lo stesso approccio aperto, local-first e agent-native applicato alle presentazioni invece che ai file di design.",
};

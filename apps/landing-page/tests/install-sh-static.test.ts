...
test('install.sh delegates to the NamVu Design CLI installer with the requested agent', () => {
...
`,
  ...
  try {
    ...
    assert.match(result.stderr, /does not look like the NamVu Design CLI/);
